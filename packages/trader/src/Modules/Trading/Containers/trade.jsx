...
const ChartTrade = observer(props => {
    ...
    const { accumulators_high_barrier, current_spot, current_spot_time } = (should_calculate_accu_barriers ? accumulator_barriers_data[symbol] : accumulator_barriers_data) || {};
