            ...
            <HorizontalSwipe
                ...
                right_hidden_component={
                    <React.Fragment>
                        ...
                        {is_advert_active ? (
                            <div className='p2p-my-ads__table-popovers__activate' onClick={onClickActivateDeactivate}>
                                <Icon custom_color='var(--general-main-1)' icon='IcArchive' size={14} />
                            </div>
                        ) : (
                            <div className='p2p-my-ads__table-popovers__deactivate' onClick={onClickActivateDeactivate}>
                                <Icon custom_color='var(--general-main-1)' icon='IcUnarchive' size={14} />
                            </div>
                        )}
                        <div className='p2p-my-ads__table-popovers__delete' onClick={onClickDelete}>
                            <Icon custom_color='var(--general-main-1)' icon='IcDelete' size={16} />
                        </div>
                    </React.Fragment>
                }
                visible_component={
