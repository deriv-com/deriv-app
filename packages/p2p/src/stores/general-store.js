...
export default class GeneralStore extends BaseStore {
    ...
    showCompletedOrderNotification(advertiser_name, order_id) {
        ...
        // we need to refresh notifications in notifications-store in the case of a bug where when user closes the notification, the notification count is not synced up with the closed notification
