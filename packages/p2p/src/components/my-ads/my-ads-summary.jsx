...
const AdSummary = ({ offer_amount, offer_currency, transaction_currency, price_rate, type }) => {
    const display_offer_amount = offer_amount ? CurrencyUtils.formatMoney(offer_currency, offer_amount, true) : '';
    const display_price_rate = price_rate ? CurrencyUtils.formatMoney(transaction_currency, price_rate, true) : '';
    const display_total =
        offer_amount && price_rate
            ? CurrencyUtils.formatMoney(transaction_currency, offer_amount * price_rate, true)
            : '';
    return (
