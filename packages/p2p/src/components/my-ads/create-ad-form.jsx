...
import { Dropdown, Icon, Input, Button, ThemedScrollbars } from '@deriv/components';
                                    ...
                                    <Field name='offer_amount'>
                                        {({ field }) => (
                                            <Input
                                                ...
                                                className='p2p-my-ads__form-field'
                                                trailing_icon={
                                                    <span className='p2p-my-ads__form-field--trailing'>{currency}</span>
                                                }
                                                onChange={e => {
                                ...
                                <Field name='default_advert_description'>
                                    {({ field }) => (
                                        <Input
                                            ...
                                            type='textarea'
                                            error={
                                                touched.default_advert_description && errors.default_advert_description
                                            }
