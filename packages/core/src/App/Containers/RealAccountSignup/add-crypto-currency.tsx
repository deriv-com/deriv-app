...
type AddCryptoCurrencyProps = {
    available_crypto_currencies: unknown;
    legal_allowed_currencies: unknown;
    has_fiat: boolean;
    hasNoAvailableCrypto: () => void;
    form_error: string;
    onSubmit: () => void;
    should_show_cancel: boolean;
    should_show_crypto_only: boolean;
    should_show_fiat_only: boolean;
    value: unknown;
};
