...
export const getContractTypesConfig = () => (
    {
        ...
        mult           : { title: localize('Multiplier options'),         trade_types: ['MULTUP', 'MULTDOWN'],        basis: ['stake'],           components: ['multiplier', 'take_profit', 'stop_loss', 'deal_cancellation'], config: { hide_duration: true } }, // hide Duration for Multiplier contracts for now
    }
);
