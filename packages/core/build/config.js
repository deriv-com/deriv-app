...
const copyConfig = base => [
    ...
    { from: path.resolve(__dirname, '../node_modules/@deriv/cashier/dist/js/**'), to: 'cashier/js', flatten: true },
    { from: path.resolve(__dirname, '../node_modules/@deriv/cashier/dist/css/**'), to: 'cashier/css/', flatten: true },
    { from: path.resolve(__dirname, '../node_modules/@deriv/cashier/dist/*.*'), to: 'cashier/js', flatten: true },
