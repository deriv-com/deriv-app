...
describe('ConnectedAppsTable', () => {
    it("should render the 'ConnectedAppsTable' component properly", async () => {
        const mockHandleToggleModal = jest.fn();
        const mockProps: React.ComponentProps<typeof ConnectedAppsTable> = {
            connectedApps: [
                {
                    app_id: 99,
        ...
        render(<ConnectedAppsTable {...mockProps} />);
