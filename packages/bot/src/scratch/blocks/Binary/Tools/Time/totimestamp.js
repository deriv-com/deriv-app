...
Blockly.Blocks.totimestamp = {
    ...
    meta(){
        return {
            'display_name': localize('Convetr to timestamp'),
            'description' : localize('Converts a string representing a date/time string into seconds since Epoch. Example: 2019-01-01 21:03:45 GMT+0800 will be converted to 1546347825. Time and time zone offset are optional.'),
        };
    },
};
