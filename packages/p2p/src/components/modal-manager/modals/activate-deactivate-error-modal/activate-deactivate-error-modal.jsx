...
const ActivateDeactivateErrorModal = () => {
    const { my_ads_store } = useStores();
    const { hideModal, is_modal_open } = useModalManagerContext();

    React.useEffect(() => {
        return () => {
            my_ads_store.setActivateDeactivateErrorMessage('');
        };
    }, []);
    ...
    return (
        <Modal
            ...
            is_open={is_modal_open && Boolean(my_ads_store.activate_deactivate_error_message)}
            small
...
export default observer(ActivateDeactivateErrorModal);
