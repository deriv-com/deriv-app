...
export const TwoFactorAuthenticationDisabled = () => {
    ...
    return (
        <div className='flex flex-1 w-full h-full sm:flex-col-reverse  sm:overflow-y-auto sm:overflow-x-hidden'>
            <section className='py-0 px-[1.4rem]'>
                <Text
                    align='start'
                    as='h2'
                    className={
                        'ml-[1.2rem] mb-[1.5] text-[1.6rem] text-system-light-prominent-text leading-normal sm:mr-1.2rem'
                    }
                    weight='bold'
                >
                ...
                <Timeline className='pt-0 px-[1.4rem] pb-[1.6rem] m-[1.2rem] w-full' lineHeight='xs'>
                    ...
                    <Timeline.Item
                        itemTitle={
                            <Text
                                align='start'
                                className='text-[1.4rem] leading-tight text-system-light-prominent-text'
                            >
