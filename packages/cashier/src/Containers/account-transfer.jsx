...
export default connect(({ client, modules }) => ({
    ...
    container: modules.cashier.cashier_store.config.account_transfer.container,
    error: modules.cashier.cashier_store.config.account_transfer.error,
    has_no_account: modules.cashier.cashier_store.config.account_transfer.has_no_account,
    has_no_accounts_balance: modules.cashier.cashier_store.config.account_transfer.has_no_accounts_balance,
    ...
    is_transfer_confirm: modules.cashier.cashier_store.config.account_transfer.is_transfer_confirm,
    is_transfer_successful: modules.cashier.cashier_store.config.account_transfer.is_transfer_successful,
    is_transfer_lock: modules.cashier.cashier_store.is_transfer_lock,
    onMount: modules.cashier.cashier_store.onMountAccountTransfer,
