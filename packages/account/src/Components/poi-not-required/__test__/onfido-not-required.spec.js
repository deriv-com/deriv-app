...
describe('<OnfidoNotRequired /> ', () => {
    it('should render <OnfidoNotRequired /> component with content', () => {
        ...
        expect(screen.getByText(/Your account does not need identity verification at this time. We will inform you if identity verification is required in the future./)).toBeInTheDocument()
