...
const TwoFactorAuthentication = ({ email_address, is_switching, logoutClient, setTwoFAStatus, getTwoFAStatus }) => {
    ...
    const getDigitStatus = React.useCallback(async () => {
        ...
        setLoading(false);
    }, [getTwoFAStatus, generateQrCode, setEnabled]);
    ...
    const TwoFactorEnabled = (
        <ThemedScrollbars is_bypassed={isMobile()} className='two-factor__scrollbars'>
            <div className='two-factor__wrapper--enabled'>
                ...
                <DigitForm is_enabled={is_two_factor_enabled} setEnabled={setEnabled} logoutClient={logoutClient} />
            </div>
        </ThemedScrollbars>
    );
