...
export const JurisdictionCardClass = cva(
    'items-center rounded-xl border-1 border-solid cursor-pointer flex flex-col justify-center w-full lg:w-[276px] relative h-full transition-shadow transition-transform duration-300 [transform-style:preserve-3d] transform-gpu',
    {
        compoundVariants: [
            {
