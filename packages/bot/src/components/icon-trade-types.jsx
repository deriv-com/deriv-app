...
const IconTradeType = ({ type, className, ...props }) => {
    switch (type.toLowerCase()) {
        case 'asiand'      : return <Icon icon='IcTradetypeAsiand'      className={className} color='brand' {...props} />;
        case 'asianu'      : return <Icon icon='IcTradetypeAsianu'      className={className} color='brand' {...props} />;
        case 'call_barrier': return <Icon icon='IcTradetypeCallBarrier' className={className} color='brand' {...props} />;
        ...
        case 'digitodd'    : return <Icon icon='IcTradetypeDigitodd'    className={className} color='brand' {...props} />;
        case 'digitover'   : return <Icon icon='IcTradetypeDigitover'   className={className} color='brand' {...props} />;
        case 'digitunder'  : return <Icon icon='IcTradetypeDigitunder'  className={className} color='brand' {...props} />;
        ...
        case 'pute'        : return <Icon icon='IcTradetypePut'         className={className} color='brand' {...props} />;
        case 'put'         : return <Icon icon='IcTradetypePut'         className={className} color='brand' {...props} />;
        case 'range'       : return <Icon icon='IcTradetypeRange'       className={className} color='brand' {...props} />;
        case 'resetcall'   : return <Icon icon='IcTradetypeResetcall'   className={className} color='brand' {...props} />;
        case 'resetput'    : return <Icon icon='IcTradetypeResetput'    className={className} color='brand' {...props} />;
        case 'runhigh'     : return <Icon icon='IcTradetypeRunhigh'     className={className} color='brand' {...props} />;
        case 'runlow'      : return <Icon icon='IcTradetypeRunlow'      className={className} color='brand' {...props} />;
        case 'tickhigh'    : return <Icon icon='IcTradetypeTickhigh'    className={className} color='brand' {...props} />;
        case 'ticklow'     : return <Icon icon='IcTradetypeTicklow'     className={className} color='brand' {...props} />;
        case 'upordown'    : return <Icon icon='IcTradetypeUpordown'    className={className} color='brand' {...props} />;
        default            : return <Icon icon='IcUnknown'              className={className} {...props} />;
    }
};
