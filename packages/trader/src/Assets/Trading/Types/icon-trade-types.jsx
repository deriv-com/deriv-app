...
const IconTradeType = ({ type, className }) => {
    ...
    if (type) {
        switch (type) {
            ...
            case 'multup':
                IconType = (
                    <path className='color1-fill' d='M9.41 1.71a2 2 0 00-2.83 0L3 5.25a2 2 0 002.81 0L7 4.13V15l2-1V4.13l1.13 1.13a2 2 0 002.82 0z' />
                );
                break;
            case 'multdown':
                IconType = (
                    <path className='color1-fill' d='M7 11.17L5.87 10a2 2 0 00-2.82 0H3l3.55 3.55a2 2 0 002.83 0L13 10a2 2 0 00-2.81 0L9 11.17V1L7 2z' />
                );
                break;
            default:
                IconType = (
