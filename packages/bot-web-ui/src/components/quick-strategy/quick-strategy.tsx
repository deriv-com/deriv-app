...
type QuickStrategyProps = {
    active_index: number;
    createStrategy: () => void;
    duration_unit_dropdown: unknown;
    getSizeDesc: () => void;
    getSizeText: () => void;
    initial_errors: unknown;
    initial_values: unknown;
    is_mobile: boolean;
    is_stop_button_visible: boolean;
    is_strategy_modal_open: boolean;
    onChangeDropdownItem: () => void;
    onChangeInputValue: () => void;
    onChangeSymbolInput: () => void;
    onHideDropdownList: () => void;
    onScrollStopDropdownList: () => void;
    setActiveTabIndex: () => void;
    setCurrentFocus: () => void;
    selected_symbol: unknown | string;
    selected_trade_type: unknown | string;
    selected_duration_unit: unknown | string;
    symbol_dropdown: unknown;
    toggleStrategyModal: () => void;
    trade_type_dropdown: unknown;
    validateQuickStrategy: () => void;
};
...
const QuickStrategy = (props: QuickStrategyProps) => {
