...
describe('DepositCryptoTryFiatOnRamp', () => {
    ...
    it('should navigate to /appstore/traders-hub/cashier/on-ramp when the link is clicked', () => {
        const mockPush = jest.fn();
        (useHistory as jest.Mock).mockReturnValue({ push: mockPush });
        ...
        expect(mockPush).toHaveBeenCalledWith('/appstore/traders-hub/cashier/on-ramp');
    });
});
