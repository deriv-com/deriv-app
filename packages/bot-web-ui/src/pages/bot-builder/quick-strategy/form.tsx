            ...
            return (
                <div className='qs__body__content__form__group' key={group_index}>
                    {group.map((field, field_index) => {
                        ...
                        if (
                            (is_mobile_or_tablet && field.hide?.includes('mobile')) ||
                            (!is_mobile_or_tablet && field.hide?.includes('desktop'))
                        ) {
                            return null;
                        }
                        ...
                        switch (field.type) {
                            ...
                            case 'number': {
                                ...
                                if (should_have?.length) {
                                    if (!should_enable && (is_mobile_or_tablet || hide_without_should_have)) {
                                        return null;
                                    }
                                    return (
                                        <QSInput
