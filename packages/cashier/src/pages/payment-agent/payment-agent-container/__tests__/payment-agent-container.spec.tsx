...
jest.mock('Pages/payment-agent/payment-agent-unlisted-withdraw-form', () =>
    jest.fn(() => 'PaymentAgentUnlistedWithdrawForm')
);
jest.mock('Pages/payment-agent/payment-agent-withdraw-confirm', () => jest.fn(() => 'PaymentAgentWithdrawConfirm'));
jest.mock('Pages/payment-agent/payment-agent-receipt', () => jest.fn(() => 'PaymentAgentReceipt'));
jest.mock('Pages/payment-agent/payment-agent-disclaimer', () => jest.fn(() => 'PaymentAgentDisclaimer'));
jest.mock('Pages/payment-agent/payment-agent-search-box', () => jest.fn(() => 'PaymentAgentSearchBox'));
