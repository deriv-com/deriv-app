        ...
        switch (code) {
            case 'DuplicateAccount':
                return (
                    <p>
                        <Localize
                            i18n_default_text='An account with your details already exists. If you are having problems signing into your account please contact email <0>support@email.com</0>'
                            components={[
                                <a
