...
describe('formatMoney', () => {
    it('should work for en-US, USD', async () => {
        ...
        const display_balance = formatMoney(1234.56, 'USD', { preferred_language });
    ...
    it('should work for en-US, USD; round decimals up', async () => {
        const preferred_language = 'en-US';
        const display_balance = formatMoney(1234.56789, 'USD', { preferred_language });
    ...
    it('should work for de-GE, USD', async () => {
        ...
        const display_balance = formatMoney(1234.56123, 'USD', { preferred_language });
    ...
    it('should work for en-IN, USD', async () => {
        ...
        const display_balance = formatMoney(123456.781, 'USD', { preferred_language });
    ...
    it('should work for en-US, BTC', async () => {
        ...
        const display_balance = formatMoney(0.1234, 'BTC', { preferred_language, fractional_digits });
    ...
    it('should work for en_US, USD (invalid locale)', async () => {
        ...
        const display_balance = formatMoney(1234, 'USD', { preferred_language });
