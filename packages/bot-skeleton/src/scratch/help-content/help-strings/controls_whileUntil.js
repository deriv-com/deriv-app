...
export default {
    text: [
        ...
        localize('Examples:'),
        localize(
            '1. In the example below, the instructions are repeated as long as the value of x is less than or equal to 10. Once the value of x reaches 10, the loop is terminated.'
        ),
        localize(
