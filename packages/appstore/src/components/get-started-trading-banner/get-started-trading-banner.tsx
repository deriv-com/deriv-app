        ...
        <div className='get-started-trading-banner'>
            <div className='get-started-trading-banner__content'>
                <div className='get-started-trading-banner__description'>
                    <Text size={is_mobile_or_tablet ? 'xs' : 'xm'} color='prominent'>
                ...
                <Icon
                    icon={`IcAppstoreLoggedOut${is_eu_user ? 'Eu' : 'NonEu'}Coins${
                        is_mobile_or_tablet ? 'Responsive' : 'Desktop'
                    }`}
                    width={is_mobile_or_tablet ? responsiveWidth : desktopWidth}
                    height={is_mobile_or_tablet ? responsiveHeight : desktopHeight}
