...
class Dropdown extends React.Component {
    ...
    handleClickOutside = event => {
        ...
        if (
            ...
            !this.wrapper_ref.contains(path[0]) && // When component is isolated (e.g, iframe, shadow DOM) event.target refers to whole container not the component. path[0] is the node that the event originated from, it does not need to walk the array
