...
describe('<CryptoTransactionsRenderer />', () => {
    ...
    const props: React.ComponentProps<typeof CryptoTransactionsRenderer> = {
        row: {
    ...
    const renderCryptoTransactionsRenderer = () =>
        render(<CryptoTransactionsRenderer row={props.row} onTooltipClick={props.onTooltipClick} />, {
    ...
    // fit('should check whether the tooltip appears beside the transaction hash if the it is processed by a third-party payment processor (CoinsPaid for now)', () => {
    //     const props = {
    //         row: {
    //             address_hash: 'tb1ql7w62elx9ucw4pj5lgw4l028hmuw80sndtntxt',
    ...
    //     userEvent.click(crypto_transactions_history_table_tooltip);
    //     expect(props.onTooltipClick).toBeCalledTimes(1);
