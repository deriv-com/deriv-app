...
export const icons = {
    ...
    common: [
        ...
        'IcCrossSolid',
        'IcCross',
        'IcDashboardHeaderBlog',
        'IcDashboardHeaderCareers',
        'IcDashboardHeaderCommunity',
        'IcDashboardHeaderContactUs',
        'IcDashboardHeaderHelpCentre',
        'IcDashboardHeaderOurLeadership',
        'IcDashboardHeaderOurStory',
        'IcDashboardHeaderPartnershipProgrammes',
        'IcDashboardHeaderPaymentMethods',
        'IcDashboardHeaderRegulatoryInfo',
        'IcDashboardHeaderWhyChooseUs',
        'IcDelete',
        'IcDemo',
        'IcDerivOutline',
        'IcDeriv',
