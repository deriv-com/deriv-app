...
export const MARTINGALE = [
        ...
        content: (
            <>
                <div className='long_description__content'>
                    <Localize
                        key={0}
                        i18n_default_text='The Martingale strategy involves increasing your stake after each loss to recoup prior losses with a single successful trade.'
                    />
                    ,
                </div>
                <div>
                    <Localize
                        key={0}
                        i18n_default_text="This article explores the Martingale strategy integrated into Deriv Bot, a versatile trading bot designed to trade assets such as forex, commodities, and derived indices. We will delve into the strategy's core parameters, its application, and provide essential takeaways for traders looking to use the bot effectively."
                    />
                    ,
                </div>
            </>
    ...
    },
    {
        content: (
            <Localize
                key={0}
                i18n_default_text='<0>Initial stake:</0> The amount you pay to enter a trade. This is the starting point for any changes in stake depending on the dynamic of the strategy being used.'
