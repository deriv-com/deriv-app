...
export const RiskToleranceWarningModal = ({ handleSubmit, isModalOpen }: TRiskToleranceWarningModal) => (
    <Modal className='md:w-[440px] sm:w-[312px]' isOpen={isModalOpen}>
        ...
        <Modal.Body className='flex flex-col mx-24'>
            <StandaloneTriangleExclamationFillIcon className='self-center fill-status-light-danger' iconSize='2xl' />
            <Text align='center' as='p' className='mt-10' size='sm'>
                CFDs and other financial instruments come with a high risk of losing money rapidly due to leverage. You
                should consider whether you understand how CFDs and other financial instruments work and whether you can
