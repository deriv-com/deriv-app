...
jest.mock('../error-dialog', () => jest.fn(() => 'mockedErrorDialog'));
jest.mock('Containers/withdrawal', () => jest.fn(() => 'mockedWithdrawal'));
jest.mock('Containers/deposit', () => jest.fn(() => 'mockedDeposit'));
