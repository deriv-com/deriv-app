...
Blockly.Blocks.get_ohlc = {
    ...
    definition(){
        return {
            ...
            tooltip        : localize('Reads Nth recent candle from a given candle list'),
    ...
    meta(){
        return {
            ...
            'description' : localize('This block returns specified candle for the selected time interval.'),
        };
    },
};
