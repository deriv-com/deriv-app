...
import { TDocumentSettings, TFile } from 'Types';
...
export type TFileUploader = {
    ...
    getSocket: () => WebSocket;
    settings?: Partial<TDocumentSettings>;
};
...
const FileUploader = React.forwardRef<TUpload, TFileUploader>(({ onFileDrop, getSocket, settings }, ref) => {
