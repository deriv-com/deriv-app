...
import ContractCardLoader from 'App/Components/Elements/ContractDrawer/contract-card-loader.jsx';
...
const CardBody = ({ contract_info, contract_update, currency, is_contract_waiting, is_multiplier, status }) => {
    ...
    const result = getDisplayStatus(contract_info);
        ...
        <ContractCardBody>
            <div className='contract-card-items-wrapper'>
                ...
                <ContractCardItem header={localize('Purchase price:')}>
                    {is_contract_waiting ? <ContractCardLoader /> : <Money amount={buy_price} currency={currency} />}
                </ContractCardItem>
                <ContractCardItem header={localize('Potential payout:')}>
                    {is_contract_waiting ? <ContractCardLoader /> : <Money currency={currency} amount={payout} />}
                </ContractCardItem>
                {is_contract_waiting && (
