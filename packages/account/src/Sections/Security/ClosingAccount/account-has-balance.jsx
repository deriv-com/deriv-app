        ...
        <React.Fragment>
            <ThemedScrollbars autohide={false} width='43rem'>
                ...
                {!!ctrader_open_positions.length && (
                    <Wrapper title={localize('Please close your positions in the following cTrader account(s):')}>
                ...
                {!!ctrader_balance.length && (
                    <Wrapper title={localize('Please withdraw your funds from the following cTrader account(s):')}>
