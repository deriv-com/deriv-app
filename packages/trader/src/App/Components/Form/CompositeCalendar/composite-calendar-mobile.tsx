...
type CompositeCalendarMobileProps = {
    current_focus: string;
    duration_list: unknown;
    from: number;
    onChange: () => void;
...
const CompositeCalendarMobile = React.memo(
    ({ input_date_range, current_focus, duration_list, onChange, setCurrentFocus }: CompositeCalendarMobileProps) => {
