...
describe('AccountInfo component', () => {
    ...
    it('should render proper "AccountType" base on the passed properties', () => {
        ...
        rerender(
            <AccountInfo account_type={MARKET_TYPES.UNREGULATED} country_standpoint={{ is_united_kingdom: true }} />
        );
        expect(screen.getByText(/gaming/i)).toBeInTheDocument();

        rerender(<AccountInfo account_type={MARKET_TYPES.UNREGULATED} country_standpoint={{ is_belgium: true }} />);
        expect(screen.getByText(/options/i)).toBeInTheDocument();

        rerender(
            <AccountInfo account_type={MARKET_TYPES.UNREGULATED} country_standpoint={{ is_isle_of_man: false }} is_eu />
        );
        expect(screen.getByText(/options/i)).toBeInTheDocument();

        rerender(
            <AccountInfo account_type={MARKET_TYPES.UNREGULATED} country_standpoint={{ is_isle_of_man: false }} />
        );
