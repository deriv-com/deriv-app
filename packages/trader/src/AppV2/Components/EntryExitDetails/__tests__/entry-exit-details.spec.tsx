...
import { TContractInfo, mockContractInfo, CONTRACT_TYPES } from '@deriv/shared';
...
describe('EntryExitDetails component', () => {
    ...
    it('should hide Entry spot for digits contracts (DIGITMATCH)', () => {
        const digits_contract_info: TContractInfo = mockContractInfo({
            entry_tick_time: 1622505600,
            entry_spot_display_value: '100',
            exit_tick_time: 1623441400,
            date_start: 1622505600,
        ...
        render(<EntryExitDetails contract_info={digits_contract_info} />);
    ...
    it('should hide Entry spot for digits contracts (DIGITEVEN)', () => {
        const digits_contract_info: TContractInfo = mockContractInfo({
            entry_tick_time: 1622505600,
            entry_spot_display_value: '100',
            exit_tick_time: 1623441400,
    ...
    it('should hide Entry spot for digits contracts (DIGITOVER)', () => {
        const digits_contract_info: TContractInfo = mockContractInfo({
            entry_tick_time: 1622505600,
            entry_spot_display_value: '100',
            exit_tick_time: 1623441400,
    ...
    it('should show Entry spot for non-digits contracts (CALL)', () => {
        const call_contract_info: TContractInfo = mockContractInfo({
            entry_tick_time: 1622505600,
            entry_spot_display_value: '100',
            exit_tick_time: 1623441400,
            date_start: 1622505600,
        ...
        render(<EntryExitDetails contract_info={call_contract_info} />);

        expect(screen.getByText('Entry spot')).toBeInTheDocument();
        expect(screen.getByText('Exit spot')).toBeInTheDocument();
    });

    it('should show Entry spot for non-digits contracts (MULTIPLIER)', () => {
        const multiplier_contract_info: TContractInfo = mockContractInfo({
            entry_tick_time: 1622505600,
            entry_spot_display_value: '100',
            exit_tick_time: 1623441400,
            date_start: 1622505600,
        ...
        render(<EntryExitDetails contract_info={multiplier_contract_info} />);
