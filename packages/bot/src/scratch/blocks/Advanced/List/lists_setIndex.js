...
Blockly.Blocks.lists_setIndex = {
    ...
    meta(){
        return {
            ...
            'description' : localize('This block replaces a specific item in a list with another given item. It can also insert new item in the list at specified position.'),
