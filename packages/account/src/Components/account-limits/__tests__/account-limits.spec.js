...
describe('<AccountLimits/>', () => {
    ...
    // let account_limits = store.client.account_limits;
    // let currency = store.client.currency;
    ...
    // store=mockStore({
    //     client:{
    //         account_limits:{ api_initial_load_error: 'error in fetching data from API' }
    //     }
    // })
    //     render(
    //         <StoreProvider store={store}>
    ...
    //     render(
    //         <StoreProvider store={store}>
    //             <AccountLimits should_show_articles />
    //         </StoreProvider>
    //     );
    //     expect(screen.getByRole('heading', { name: /account limits/i })).toBeInTheDocument();
    //     expect(
    ...
    //         })
    //     ).toBeInTheDocument();
    //     const { open_positions } = account_limits;
    //     expect(
    //         screen.getByRole('cell', {
    //             name: open_positions,
    //         })
    ...
    //         </StoreProvider>
    //     );
    //     const { account_balance } = account_limits;
    //     expect(formatMoney).toHaveBeenCalledWith(currency, account_balance, true);
    // });
    ...
    //     expect(formatMoney).toHaveBeenCalledWith(currency, num_of_days_limit, true);
    // });
    ...
    //         </PlatformContext.Provider>
    //     );
    //     const { withdrawal_since_inception_monetary, remainder } = account_limits;

    //     expect(screen.getByText(/total withdrawn/i)).toBeInTheDocument();
    //     expect(formatMoney).toHaveBeenCalledWith(currency, withdrawal_since_inception_monetary, true);

    //     expect(screen.getByText(/maximum withdrawal remaining/i)).toBeInTheDocument();
    //     expect(formatMoney).toHaveBeenCalledWith(currency, remainder, true);
    // });
