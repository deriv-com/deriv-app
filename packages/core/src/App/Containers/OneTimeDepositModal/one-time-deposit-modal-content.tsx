...
export const OneTimeDepositModalContent = observer(({ is_crypto_account = false }: { is_crypto_account?: boolean }) => {
    ...
    return (
        <div
            className={classNames('one-time-deposit-modal__content', {
                'one-time-deposit-modal__content-crypto': is_crypto_account,
            })}
        >
