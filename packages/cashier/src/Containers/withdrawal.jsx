...
export default connect(({ client, modules }) => ({
    ...
    check10kLimit: modules.cashier.withdraw_store.check10kLimit,
    ...
    is_withdraw_confirmed: modules.cashier.withdraw_store.is_withdraw_confirmed,
    is_withdrawal_locked: modules.cashier.withdraw_store.is_withdrawal_locked,
    recentTransactionOnMount: modules.cashier.transaction_history.onMount,
    setActiveTab: modules.cashier.cashier_store.setActiveTab,
    setErrorMessage: modules.cashier.withdraw_store.error.setErrorMessage,
    tab_index: modules.cashier.cashier_store.cashier_route_tab_index,
    verification_code: client.verification_code.payment_withdraw,
    verify_error: modules.cashier.withdraw_store.verification.error,
    willMountWithdraw: modules.cashier.withdraw_store.willMountWithdraw,
}))(Withdrawal);
