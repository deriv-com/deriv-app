...
export const getContractTypesConfig = () => ({
    ...
    touch: {
        ...
        title: localize('Ends Between/Ends Outside'),
        trade_types: ['EXPIRYMISS', 'EXPIRYRANGE'],
        basis: ['stake', 'payout'],
        components: ['barrier'],
    },
    stay: {
        title: localize('Stays Between/Goes Outside'),
    ...
    mult: {
        title: localize('Multiplier options'),
        trade_types: ['MULTUP', 'MULTDOWN'],
        basis: ['stake'],
        components: ['multiplier', 'take_profit', 'stop_loss', 'deal_cancellation'],
