...
import { getDropdownList, getHoursList, isTimeEdited } from 'Utils/business-hours';
...
type TBusinessHourModalEditProps = {
    ...
    is_disabled: boolean;
    saved_details: TData[];
    setIsDisabled: (is_disabled: boolean) => void;
};
...
const BusinessHourModalEdit = React.forwardRef(
    ({ data, is_disabled, saved_details, setIsDisabled }: TBusinessHourModalEditProps, ref) => {
        ...
        React.useEffect(() => {
            const is_edited = isTimeEdited(data, edited_data);
            if (is_disabled !== !is_edited) setIsDisabled(!is_edited);
        }, [data, edited_data, is_disabled, setIsDisabled]);
            ...
            <div className='business-hour-modal-edit'>
                ...
                <div className='business-hour-modal-edit__selector'>
                    {edited_data.map((day, idx) => {
                        ...
                        return (
                            <div
                                className='business-hour-modal-edit__selector-item'
                                key={`${day.value}_${day.start_time}`}
                            >
                                <Text
                                ...
                                >
                                    ...
                                    dropdown_open_states[day.value] ? (
                                        ...
                                        <div
                                            ...
                                            role='button'
                                        >
                                            <Text color={includes_day ? 'prominent' : 'less-prominent'} size='xxs'>
