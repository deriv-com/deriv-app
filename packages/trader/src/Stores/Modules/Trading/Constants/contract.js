...
export const getContractTypesConfig = () => (
    {
        ...
        mult           : { title: localize('Multiplier option'),          trade_types: ['MULTUP', 'MULTDOWN'],        basis: ['stake'],           components: ['multiplier', 'take_profit', 'stop_loss', 'cancel_deal'], config: { hide_duration: true } }, // hide Duration for Multiplier contracts for now
    }
);
