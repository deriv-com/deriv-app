...
const getBrokerDetails = { display_name: 'Deriv Limited (Deriv)', name: 'Deriv Limited' };
...
export { getServerName, getBrokerDetails, getPlatformMt5DownloadLink, getMT5WebTerminalLink };
