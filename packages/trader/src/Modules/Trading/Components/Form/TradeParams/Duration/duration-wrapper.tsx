...
type DurationWrapperProps = {
    advanced_duration_unit: string;
    advanced_expiry_type: string;
    contract_expiry_type: string;
    duration: unknown | number | string;
    duration_d: number;
    duration_h: number;
    duration_m: number;
    duration_min_max: unknown;
    duration_s: number;
    duration_t: unknown | number | string;
    duration_unit: string;
    duration_units_list: unknown;
    expiry_date: unknown | string | number;
    expiry_time: string;
    expiry_type: string;
    getDurationFromUnit: () => void;
    is_advanced_duration: boolean;
    is_minimized: boolean;
    market_open_times: unknown;
    onChange: () => void;
    onChangeMultiple: () => void;
    onChangeUiStore: () => void;
    sessions: unknown;
    simple_duration_unit: string;
    start_date: unknown | number | string;
    start_time: string;
    symbol: string;
};

const DurationWrapper = (props: DurationWrapperProps) => {
    const {
