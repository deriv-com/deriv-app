        ...
        switch (category) {
            ...
            case 'vanilla':
                IconCategory = (
                    <React.Fragment>
                        <div className='category-wrapper'>
                            <Icon icon='IcTradetypeVanillaLongCall' className='category-type' color='brand' size={24} />
                        </div>
                        <div className='category-wrapper'>
                            <Icon icon='IcTradetypeVanillaLongPut' className='category-type' color='brand' size={24} />
                        </div>
                    </React.Fragment>
                );
                break;
