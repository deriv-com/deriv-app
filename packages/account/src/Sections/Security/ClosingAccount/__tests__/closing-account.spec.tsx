...
describe('<ClosingAccountReason />', () => {
    it('should render the ClosingAccountReason component', async () => {
        render(<ClosingAccount />);
        expect(screen.getByTestId('dt_closing_account')).toBeInTheDocument();
    });

    it('should render the ClosingAccountSteps component if render_close_account_reason is false', async () => {
        render(<ClosingAccount />);
        expect(screen.getByText('ClosingAccountSteps')).toBeInTheDocument();
    });

    it('should render the ClosingAccountReason component if render_close_account_reason is true', async () => {
