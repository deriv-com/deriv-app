...
type CashierDefaultProps = {
    accounts_list: unknown;
    available_crypto_currencies: unknown;
    currency: string;
    ...
    onMountCashierDefault: () => void;
    openRealAccountSignup: () => void;
    shouldNavigateAfterChooseCrypto: () => void;
    shouldNavigateAfterPrompt: () => void;
    setIsCashierDefault: () => void;
    setIsDeposit: () => void;
    setDepositTarget: () => void;
    setShouldShowAllAvailableCurrencies: () => void;
    setSideNotes: () => void;
    showP2pInCashierDefault: () => void;
    show_p2p_in_cashier_default: boolean;
