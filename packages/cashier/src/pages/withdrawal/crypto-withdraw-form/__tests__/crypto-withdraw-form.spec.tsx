...
const mockUseAccountPlatformDetails = useAccountPlatformDetails as jest.MockedFunction<
    typeof useAccountPlatformDetails
>;

describe('<CryptoWithdrawForm />', () => {
    mockUseAccountPlatformDetails.mockReturnValue({ icon: 'icon' });
    let mockRootStore;
    beforeEach(() => {
        mockRootStore = {
            client: {
