...
const TradeCategoriesGIF = ({ category }) => {
    switch (category) {
        case 'asian'          : return <ImageAsianUpDown />;
        case 'callputspread'  : return <ImageSpread />;
        case 'end'            : return <ImageEndsInOut />;
        case 'even_odd'       : return <ImageEvenOdd />;
        case 'high_low'       : return <ImageHighLow />;
        case 'lb_call'        : return <ImageCloseToLow />;
        case 'lb_put'         : return <ImageHighToClose />;
        case 'lb_high_low'    : return <ImageHighToLow />;
        case 'rise_fall'      : return <ImageRiseFall />;
        case 'rise_fall_equal': return <ImageRiseFall />;
        case 'match_diff'     : return <ImageMatchDiff />;
        case 'multiplier'     : return <ImageMultiplier />;
        case 'over_under'     : return <ImageOverUnder />;
        case 'reset'          : return <ImageReset />;
        case 'run_high_low'   : return <ImageRunHighLow />;
        case 'stay'           : return <ImageStaysInGoesOut />;
        case 'tick_high_low'  : return <ImageTickHighLow />;
        case 'touch'          : return <ImageTouch />;
        default               : return null;
    }
};
