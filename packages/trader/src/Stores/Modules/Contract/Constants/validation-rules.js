    ...
    contract_update_stop_loss: {
        rules: [
            [
                'req',
                {
                    condition: store => store.has_contract_update_stop_loss && !store.contract_update_stop_loss,
    ...
    contract_update_take_profit: {
        rules: [
            [
                'req',
                {
                    condition: store => store.has_contract_update_take_profit && !store.contract_update_take_profit,
