...
const Contract = ({ contract_type, contract_types_list, is_equal, onChange, symbol }) => {
    ...
    return (
        <React.Fragment>
            {isDigitTradeType(contract_type) && (
                <ToastInfoPopup portal_id='deriv_app' message={digits_message} is_open={true} timeout={3000} />
            )}
            <ContractTypeWidget
                is_equal={is_equal}
                list={list}
