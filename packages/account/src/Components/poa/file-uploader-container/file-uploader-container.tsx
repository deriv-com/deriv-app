...
import { TFileUploaderContainer } from 'Types';
import { TUpload } from 'Components/file-uploader/file-uploader';
...
const PoaFileUploaderContainer = ({
    ...
    const ref = React.useRef<TUpload>(null);
    ...
    return (
        <div className='account__file-uploader-section' data-testid='dt_file_uploader_container'>
