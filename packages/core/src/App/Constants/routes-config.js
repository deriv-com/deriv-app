...
const initRoutesConfig = () => ([
    ...
    { path: routes.redirect,  component: Redirect,       title: localize('Redirect') },
    {
        ...
        routes          : [
            ...
            { path: routes.cashier_pa,           component: PaymentAgent,         title: localize('Payment agents'),     icon_component: 'IcPaymentAgent' },
            { path: routes.cashier_acc_transfer, component: AccountTransfer,      title: localize('Transfer'),           icon_component: 'IcAccountTransfer' },
