...
export const POICountrySelector = ({ onCountrySelect }: { onCountrySelect: (value: string) => void }) => {
    return (
        <div className='flex flex-col gap-10'>
            ...
            <CountrySelector handleSelect={onCountrySelect} label='Country' name='country' />
        </div>
    );
};
