...
const MyProfile = observer(() => {
    ...
    const [on_screen_keyboard, toggleOnScreenKeyboard] = React.useState(false);
    const [show_real_name, toggleShowRealName] = React.useState(false);
    ...
    const setCurrentFocus = target => {
        toggleOnScreenKeyboard(general_store.props.is_mobile && target);
    };
    ...
    return (
        <div className='my-profile'>
            ...
            <MobileWrapper>
                <ThemedScrollbars scroll_offset='200px'>
                    <div className='my-profile__header'>
                        <div className='my-profile__header-details'>
                            <div
                                className='my-profile__header-avatar'
                    ...
                    <React.Fragment>
                        <div className='my-profile__content'>
                            <div className='my-profile__stats'>
                                <div className='my-profile__stats-cell-separator' />
                                <div className='my-profile__stats-cell'>
                            ...
                            <div className='my-profile__separator'>
                                <div className='my-profile__separator-text'>{localize('Privacy setting')}</div>
                                <div className='my-profile__separator-horizontal_line' />
                            </div>
                            <div className='my-profile__privacy-setting'>
                                <ToggleSwitch
                                    id='p2p_profile_real_name'
                                    classNameLabel='my-profile__privacy-setting-switch'
                                    classNameButton='my-profile__privacy-setting-switch-button'
                                    handleToggle={() => {
                                        toggleShowRealName(!show_real_name);
                                    }}
                                    is_enabled={show_real_name}
                                />
                                <span className='my-profile__privacy-setting-text'>
                                    {localize('Show my real name')}({general_store.nickname})
                                </span>
                            </div>
                            <div className='my-profile__separator'>
                                <div className='my-profile__separator-text'>{localize('Ad template')}</div>
                                            ...
                                            <React.Fragment>
                                                <Field name='payment_info'>
                                                    {({ field }) => (
                                                        <Input
                                                            ...
                                                            has_character_counter
                                                            initial_character_count={
                                                                my_profile_store.payment_info.length
                                                            }
                                                            max_characters={300}
                                                ...
                                                <Field name='contact_info'>
                                                    {({ field }) => (
                                                        <Input
                                                            ...
                                                            has_character_counter
                                                            initial_character_count={
                                                                my_profile_store.contact_info.length
                                                            }
                                                            max_characters={300}
                                                            onFocus={e => setCurrentFocus(e.currentTarget.name)}
                                                            onBlur={() => setCurrentFocus(null)}
                                                ...
                                                <div
                                                    className={classNames('my-profile__footer', {
                                                        'my-profile__footer--inherit': on_screen_keyboard,
                                                    })}
                                                >
                                                    <FormError message={my_profile_store.form_error} />
