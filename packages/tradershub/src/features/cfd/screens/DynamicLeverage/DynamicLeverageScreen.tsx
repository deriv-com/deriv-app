...
const DynamicLeverageScreen = () => {
    ...
    return (
        <div
            className={qtMerge(
                'flex flex-col gap-24 mt-[15px] mx-24 mb-24 sm:mx-[128px] sm:mb-50 pb-5000 absolute top-50 [transform:rotateY(180deg)] transition-transform ease-in duration-[0.6s] backface-hidden',
