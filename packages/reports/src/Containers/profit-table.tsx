...
import { TInputDateRange, TColIndex, TColumnTemplateType } from 'Types';
...
const getRowAction = (row_obj: { [key: string]: string }) => {
    ...
    if (contract_type && !isForwardStarting(row_obj.shortcode, +row_obj.purchase_time_unix)) {
        return getContractPath(+row_obj.contract_id);
    }
    return '';
};
