...
export const DESCRIPTION_VIDEO_ID: TDtraderVideoUrl = {
    accumulator: {
        light: 'c4b95d108a456bd2ec177499abbeec6d',
        dark: '49e8a355c5a69b127b225a1eb1a0d70d',
    },
    turbos: {
...
export const getDescriptionDownloadUrl = (is_mobile = false, is_dark_theme = false) => {
    const uid = ACCU_MANUAL_VIDEO_ID[is_mobile ? 'mobile' : 'desktop'][is_dark_theme ? 'dark' : 'light'];
