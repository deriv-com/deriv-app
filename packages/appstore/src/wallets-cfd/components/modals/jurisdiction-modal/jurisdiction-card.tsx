...
import { TJurisdictionCardProps } from '@deriv/cfd/src/Containers/props.types';
import { getJurisdictionContents } from '@deriv/cfd/src/Constants/jurisdiction-contents/jurisdiction-contents';
