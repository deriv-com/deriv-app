...
const Trade = observer(() => {
    ...
    const form_wrapper_class = is_responsive ? 'mobile-wrapper' : 'sidebar__container desktop-only';
    ...
    return (
        <div
            ...
            id='trade_container'
        >
            {!is_tablet_or_below && <PositionsDrawer />}
            ...
            >
                <NotificationMessages show_trade_notifications={is_responsive} />
                <React.Suspense
