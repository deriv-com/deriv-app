...
const WithdrawalLocked = ({
    ...
    const is_poa_authentication_needed = is_10K_limit && is_pending_authentication;
    ...
    const items = [
        ...(is_poi_needed
            ...
            : []),
        ...(is_poa_needed || is_poa_authentication_needed
            ? [
                  {
                      content: is_poa_authentication_needed
