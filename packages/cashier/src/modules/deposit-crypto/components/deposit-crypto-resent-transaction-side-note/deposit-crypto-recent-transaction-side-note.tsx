...
import './deposit-crypto-recent-transaction-side-note.scss';

const DepositCryptoRecentTransactionSideNote: React.FC = observer(() => {
    const { ui } = useStore();
    const { is_mobile } = ui;
...
export default DepositCryptoRecentTransactionSideNote;
