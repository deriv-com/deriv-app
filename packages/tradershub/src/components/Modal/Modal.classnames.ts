...
export const ModalFooterClass = cva(
    'grid grid-cols-1 gap-400 p-800 border border-solid border-t-100 border-system-light-secondary-background bottom-0 lg:grid-cols-2 lg:flex lg:items-center lg:px-1200 lg:py-800',
    {
        variants: {
            align: {
