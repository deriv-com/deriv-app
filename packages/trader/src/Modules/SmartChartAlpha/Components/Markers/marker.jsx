...
const ChartMarkerAlpha = ({ marker_config, marker_content_props, is_bottom_widget_visible }) => {
    ...
    return <FastMarkerAlpha markerRef={onRef}>{getMemoizedComponent()}</FastMarkerAlpha>;
};
