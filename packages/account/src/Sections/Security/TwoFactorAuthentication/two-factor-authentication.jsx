...
const TwoFactorAuthentication = observer(() => {
    ...
    const { email_address, getTwoFAStatus, has_enabled_two_fa, is_switching, setTwoFAStatus, logout } = client;
    ...
    const TwoFactorEnabled = (
        <ThemedScrollbars is_bypassed={isMobile()} className='two-factor__scrollbars'>
            <div className='two-factor__wrapper--enabled'>
                ...
                <DigitForm is_enabled={has_enabled_two_fa} setTwoFAStatus={setTwoFAStatus} logoutClient={logout} />
            </div>
        </ThemedScrollbars>
    );
