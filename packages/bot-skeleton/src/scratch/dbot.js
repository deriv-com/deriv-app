...
class DBot {
    ...
    // eslint-disable-next-line
    emitObserverEvent() {
        globalObserver.emit('test_event');
    }

    // eslint-disable-next-line class-methods-use-this
    async initMobile(store, api_helpers_store) {
        ...
        // console.log({'ApiHelpers': ApiHelpers.instance});
    }
    ...
    async initWorkspace(public_path, store, api_helpers_store) {
        try {
            ...
            console.log(ApiHelpers.instance); // eslint-disable-line
            DBotStore.setInstance(store);
