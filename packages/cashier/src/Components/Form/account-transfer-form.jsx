...
export default connect(({ client, modules, ui }) => ({
    ...
    converter_from_amount: modules.cashier.cashier_store.converter_from_amount,
    converter_from_error: modules.cashier.cashier_store.converter_from_error,
    converter_to_amount: modules.cashier.cashier_store.converter_to_amount,
    converter_to_error: modules.cashier.cashier_store.converter_to_error,
    crypto_transactions: modules.cashier.transaction_history.crypto_transactions,
    is_crypto: modules.cashier.cashier_store.is_crypto,
    is_dark_mode_on: ui.is_dark_mode_on,
    is_dxtrade_allowed: client.is_dxtrade_allowed,
    minimum_fee: modules.cashier.cashier_store.config.account_transfer.minimum_fee,
    mt5_login_list: client.mt5_login_list,
    onChangeTransferFrom: modules.cashier.cashier_store.onChangeTransferFrom,
    onChangeTransferTo: modules.cashier.cashier_store.onChangeTransferTo,
    onMount: client.getLimits,
    percentage: modules.cashier.cashier_store.percentage,
    resetConverter: modules.cashier.cashier_store.resetConverter,
    recentTransactionOnMount: modules.cashier.transaction_history.onMount,
    setAccountTransferAmount: modules.cashier.cashier_store.setAccountTransferAmount,
    setErrorMessage: modules.cashier.cashier_store.config.account_transfer.error.setErrorMessage,
    ...
    setTransferPercentageSelectorResult: modules.cashier.cashier_store.setTransferPercentageSelectorResult,
    should_percentage_reset: modules.cashier.cashier_store.should_percentage_reset,
    transfer_fee: modules.cashier.cashier_store.config.account_transfer.transfer_fee,
    transfer_limit: modules.cashier.cashier_store.config.account_transfer.transfer_limit,
    validateTransferFromAmount: modules.cashier.cashier_store.validateTransferFromAmount,
    validateTransferToAmount: modules.cashier.cashier_store.validateTransferToAmount,
}))(AccountTransferForm);
