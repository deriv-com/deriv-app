...
describe('<SelfExclusion />', () => {
    ...
    beforeEach(() => {
        store.client.currency = 'Test currency';
        store.client.is_cr = false;
        store.client.is_eu = false;
        store.client.landing_company_shortcode = 'dxb';
        store.client.is_switching = false;
        store.ui.is_tablet = false;
        store.client.is_uk = false;
        store.client.is_virtual = false;
        store.client.logout = jest.fn();
