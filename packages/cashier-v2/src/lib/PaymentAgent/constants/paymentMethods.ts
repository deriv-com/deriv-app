...
export const paymentMethods = {
    ...
    'Diamond Bank': ['Diamond bank', 'Diamond Bank', 'DiamondBank', 'Diamon Bank'],
    ...
    'E-payment': [
        ...
        'bank transfer and all form of E-payments',
        'Bank Transfer and all Forms of E-payments',
        'all form of E-payments and E-wallet payment',
    ...
    'E-wallet': [
        ...
        'E-wallet Crypto for BTC and ETH',
    ],
    ...
    'Fidelity Bank': ['Fidelity Bank', 'fidelitybank', 'FIDELITY BANK'],
    ...
    Innbucks: ['Innbucks', 'INNBUCKS', 'Inbucks', 'InnBucks'],
    'Instant Bank Transfer': ['Instant Bank Transfer', 'Instant bank transfer'],
    'Instant Money': [
        'Instant Money',
        'InstantMoney',
    ...
    'Interswitch Debit Cards': ['Interswitch Debit Cards', 'Interswitch Debit cards'],
    'Itau Bank': ['Itau Bank', 'Itau'],
    IZI: ['IZI', 'Izzy'],
    JazzCash: ['JazzCash', 'jazzcash', 'Jazz cash', 'Jazzcash', 'Jazz-Cash', 'JazzCashTransfer'],
    JENIUS: ['JENIUS', 'Jenius'],
    Jeton: ['Jeton', 'jeton', 'JetonWallet', 'JetOn'],
    'KCB Bank': ['KCB Bank', 'KCB bank'],
    'Key Stone Bank': ['Key Stone Bank', 'Keystone', 'Key stone Bank', 'Keystone Bank'],
    'Kuda Bank': [
        'Kuda Bank',
        'KUDA BANK',
        'Kuda MFB',
    ...
    MoMo: ['MoMo', 'MOMO', 'MoMo pay', 'MTN MOMO', 'MTN Momo', 'MTNMOMO'],
    ...
    'Nigeria local bank': ['Nigeria Local', 'Nigeria local bank', 'NIGERIA LOCAL BANK', 'Local Nigerian banks'],
    ...
    Opay: ['Opay', 'OPAY', 'OPay', 'opay', '0pay', '0Pay'],
    ...
    PalmPay: ['PalmPay', 'PALMPAY', 'PalmpayMFB', 'Palmpay'],
    ...
    Pix: ['Pix', 'PIX'],
    'Polaris Bank': ['Polaris Bank', 'Polaris', 'Polaris bank'],
    ...
    Webmoney: ['Perfect Money and Webmoney', 'Webmoney', 'WebMoney', 'Web Money', 'Web money', 'webmoney'],
    'WeChat Pay': ['WeChat Pay', 'WeChatPay'],
    'Wema Bank': ['Wema Bank', 'Wema bank', 'Wema'],
    WesternUnion: ['Western union', 'Western Union', 'WesternUnion', 'westernunion'],
    Wise: ['Wise', 'transferwise'],
    'World Remit': ['World remit', 'World Remit', 'WorldRemit', 'world remit', 'CoinbaseworldRemit'],
