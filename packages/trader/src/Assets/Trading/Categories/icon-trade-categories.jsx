...
import IconTradeType from '../Types/icon-trade-types.jsx';
    ...
    if (category) {
        switch (category) {
            ...
            case 'asian':
                IconCategory = (
                    <React.Fragment>
                        ...
                        <div className='category-wrapper'>
                            <Icon con='IcTradetypeAsiand' className='category-type' color='brand' />
                        </div>
                    </React.Fragment>
                );
                break;
            case 'lb_call':
                IconCategory = (
                    <div className='category-wrapper'>
                        <Icon className='category-type' color='brand' type='lbfloatcall' />
                    </div>
                );
                break;
            case 'lb_put':
                IconCategory = (
                    <div className='category-wrapper'>
                        <Icon className='category-type' color='brand' type='lbfloatput' />
                    </div>
                );
                break;
            case 'lb_high_low':
                IconCategory = (
                    <div className='category-wrapper'>
                        <Icon className='category-type' color='brand' type='lbhighlow' />
                    </div>
                );
                break;
            case 'reset_call_put':
                IconCategory = (
                    <React.Fragment>
                        <div className='category-wrapper'>
                            <IconTradeType className='category-type' type='resetcall' />
                        </div>
                        <div className='category-wrapper'>
                            <IconTradeType className='category-type' type='resetput' />
                        </div>
                    </React.Fragment>
                );
                break;
