...
import { switchToTickChart }      from './Helpers/chart-notifications';
...
export default class ContractTradeStore extends BaseStore {
    ...
    updateGranularity(granularity) {
        ...
        if (this.granularity === 0) {
            this.root_store.ui.removeNotificationMessage(switchToTickChart());
        }
    }
    ...
    addContract({
        ...
        if (is_tick_contract && this.granularity !== 0) {
            this.root_store.ui.addNotificationMessage(switchToTickChart());
        }
    }
