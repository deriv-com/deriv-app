...
export const MARTINGALE: TStrategy = {
...
export const REVERSE_MARTINGALE: TStrategy = {
    ...
    fields: [
        ...
        [LABEL_PROFIT, PROFIT, LABEL_LOSS, LOSS, LABEL_REVERSE_MARTINGALE_SIZE, SIZE, CHECKBOX_MAX_STAKE, MAX_STAKE],
    ],
};

export const D_ALEMBERT: TStrategy = {
    name: 'dalembert_max-stake',
    label: localize('D’Alembert'),
    rs_strategy_name: `d'alembert`,
    description: D_ALEMBERT_CONTENT,
    fields: [
        [
            LABEL_SYMBOL,
            SYMBOL,
...
export const STRATEGY_1_3_2_6: TStrategy = {
    name: '1_3_2_6',
    label: localize('1-3-2-6'),
    rs_strategy_name: '1-3-2-6',
    description: STRATEGY_1_3_2_6_CONTENT,
    fields: [
        [
            LABEL_SYMBOL,
            SYMBOL,
