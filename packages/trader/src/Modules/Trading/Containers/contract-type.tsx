...
type ContractProps = {
    ...
    contract_types_list: unknown;
    is_digit_view: boolean;
    is_equal: unknown | number | string;
    onChange: () => void;
    symbol: string;
};

const Contract = ({ contract_type, contract_types_list, is_digit_view, is_equal, onChange, symbol }: ContractProps) => {
