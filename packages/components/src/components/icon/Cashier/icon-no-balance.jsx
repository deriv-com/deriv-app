...
const IconTransferDone = ({ className }) => (
    <svg className={className} width='116' height='105' viewBox='0 0 116 105'>
        <g fill='none' fillRule='evenodd' transform='translate(-6 -12)'>
            ...
            <circle cx='99.6' cy='94.45' r='22.4' fill='#FF444F' fillRule='nonzero' />
            <path fill='#FFF' fillRule='nonzero' d='M97.34 102.81v-.61c0-1.09.66-1.93 2.26-1.93 1.6 0 2.25.84 2.25 1.93v.61c0 1.09-.66 1.92-2.25 1.92-1.59 0-2.26-.83-2.26-1.92zm1.5-6.49l-1.2-7.2V84.2a2.38 2.38 0 0 1 4 0v4.92l-1.17 7.2a.84.84 0 0 1-1.59 0h-.04z' />
        </g>
    </svg>
);
