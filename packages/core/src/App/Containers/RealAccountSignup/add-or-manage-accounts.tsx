...
type AddOrManageAccountsProps = {
    available_crypto_currencies: unknown;
    onError: () => void;
    onLoading: () => void;
    onSuccessSetAccountCurrency: () => void;
    is_eu: boolean;
    setCurrency: () => void;
    createCryptoAccount: () => void;
    has_fiat: boolean;
    can_change_fiat_currency: boolean;
    current_currency_type: string;
    is_loading: boolean;
    is_add_crypto: boolean;
    setLoading: () => void;
    setShouldShowCancel: () => void;
};

const AddOrManageAccounts = (props: AddOrManageAccountsProps) => {
    const {
