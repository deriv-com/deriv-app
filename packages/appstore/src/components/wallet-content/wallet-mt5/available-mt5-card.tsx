...
const AvailableMT5Card = observer(({ account }: { account: TFilteredWalletMT5Account }) => {
    const {
        client,
        modules: { cfd },
        traders_hub,
    ...
    const { selected_region, selected_account_type, is_eu_user, getAccount, no_MF_account, is_real, no_CR_account } =
        traders_hub;
