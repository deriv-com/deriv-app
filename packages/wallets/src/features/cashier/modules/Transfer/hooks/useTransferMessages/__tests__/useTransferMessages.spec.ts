...
describe('useTransferMessages', () => {
    ...
    test('should render default objects correctly for verified account', () => {
    ...
    test('should render default objects correctly for unverified account', () => {
    ...
    test('should return correct error message when error available in current transfer', () => {
    ...
    test('should not render transfer messages when no active wallet set', () => {
