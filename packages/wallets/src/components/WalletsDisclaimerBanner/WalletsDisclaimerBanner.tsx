            ...
            <>
                <Text size='xs'>
                    <Localize
                        ...
                        i18n_default_text='The products offered on our website are complex derivative products that carry a significant risk of potential loss. CFDs are complex instruments with a high risk of losing money rapidly due to leverage. <0>75% of retail investor accounts lose money when trading CFDs with this provider.</0> You should consider whether you understand how these products work and whether you can afford to take the high risk of losing your money.'
                    />
                </Text>
    ...
    return (
        <>
            <Text size='xs' weight='bold'>
                <Localize i18n_default_text='75% of retail investor accounts lose money when trading CFDs with this provider. ' />
            </Text>
            <div className='wallets-disclaimer-banner__content__icon'>
