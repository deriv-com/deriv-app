...
const IconAccountsCurrency = ({ type, className, height = 24, width = 24 }) => {
            ...
            case 'real':
                IconCurrency = (
                    <g fill='none' fillRule='nonzero'>
                        <path fill='#4BB4B3' d='M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12' />
                        <path fill='#FFF' d='M10.324 14.25v-3.127c1.032-.041 1.807-.222 2.323-.542.516-.32.775-.862.775-1.625V8.67c0-.518-.147-.913-.442-1.186-.294-.272-.676-.409-1.147-.409-.51 0-.931.164-1.264.491-.334.327-.56.743-.677 1.247L7.5 7.77c.118-.408.288-.807.51-1.195.222-.389.513-.736.872-1.043.36-.306.791-.555 1.294-.746.504-.19 1.089-.286 1.755-.286.68 0 1.301.102 1.863.307.562.204 1.046.49 1.451.858s.716.81.931 1.329c.216.518.324 1.09.324 1.717 0 .572-.092 1.09-.275 1.553a3.888 3.888 0 0 1-1.843 2.064 4.565 4.565 0 0 1-1.313.45v1.472h-2.745zm1.301 5.25c-.674 0-1.155-.156-1.443-.469-.288-.312-.432-.696-.432-1.15v-.512c0-.454.144-.838.432-1.15.288-.313.769-.469 1.443-.469s1.155.156 1.443.469c.288.312.432.696.432 1.15v.512c0 .454-.144.838-.432 1.15-.288.313-.769.469-1.443.469z' />
                    </g>
                );
                break;
            default:
    ...
    return (
        <svg className={classNames('inline-icon', className)} width={width} height={height} viewBox='0 0 24 24'>
            {IconCurrency}
        </svg>
    );
};
