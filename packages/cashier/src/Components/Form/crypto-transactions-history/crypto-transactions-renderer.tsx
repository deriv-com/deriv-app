...
type CryptoTransactionsRendererProps = {
    crypto: unknown;
    currency: string;
    cancelCryptoTransaction: () => void;
    showCryptoTransactionsCancelModal: () => void;
    showCryptoTransactionsStatusModal: () => void;
};
...
}: CryptoTransactionsRendererProps) => {
    const {
        address_hash,
        address_url,
        amount,
