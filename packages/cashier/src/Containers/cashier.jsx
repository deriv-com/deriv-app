...
export default connect(({ client, common, modules, ui }) => ({
    is_account_transfer_visible: modules.cashier.general.is_account_transfer_visible,
    is_account_setting_loaded: client.is_account_setting_loaded,
    is_logged_in: client.is_logged_in,
    is_logging_in: client.is_logging_in,
    is_onramp_tab_visible: modules.cashier.general.onramp.is_onramp_tab_visible,
    is_p2p_enabled: modules.cashier.general.is_p2p_enabled,
    is_payment_agent_transfer_visible: modules.cashier.general.is_payment_agent_transfer_visible,
    is_payment_agent_visible: modules.cashier.general.is_payment_agent_visible,
    is_virtual: client.is_virtual,
    is_visible: ui.is_cashier_visible,
    onMount: modules.cashier.general.onMountCommon,
    p2p_notification_count: modules.cashier.general.p2p_notification_count,
    routeBackInApp: common.routeBackInApp,
    setAccountSwitchListener: modules.cashier.general.setAccountSwitchListener,
    setTabIndex: modules.cashier.general.setCashierTabIndex,
    tab_index: modules.cashier.general.cashier_route_tab_index,
