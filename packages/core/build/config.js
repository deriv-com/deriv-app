...
const copyConfig = (base) => ([
    ...
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/account.svg'),    to: 'account.svg',    toType: 'file' },
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/common.svg'),     to: 'common.svg',     toType: 'file' },
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/currency.svg'),   to: 'currency.svg',   toType: 'file' },
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/flag.svg'),       to: 'flag.svg',       toType: 'file' },
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/mt5.svg'),        to: 'mt5.svg',        toType: 'file' },
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/tradetype.svg'),  to: 'tradetype.svg',  toType: 'file' },
    { from: path.resolve(__dirname, '../node_modules/deriv-components//lib/icon/sprite/underlying.svg'), to: 'underlying.svg', toType: 'file' },
