...
const DesktopInfoIcons = observer(({ wallet_account, active_account }: TDesktopInfoIcons) => {
    const { ui } = useStore();
    ...
    return (
        <div className='acc-info__wrapper'>
            ...
            >
                ...
                >
                    {!is_mobile && <DesktopInfoIcons wallet_account={linked_wallet} active_account={active_account} />}
