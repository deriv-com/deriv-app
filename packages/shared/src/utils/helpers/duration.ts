...
export const buildDurationConfig = (
    ...
    const new_object = Object.create(durations.min_max[contract.start_type as keyof typeof durations.min_max]);

    new_object[contract.expiry_type as keyof typeof duration_min_max] = {
