import { buildBarriersConfig, getAccuBarrierSpotDistance, getAccumulatorBarriers } from '../barrier';
...
describe('getAccuBarrierSpotDistance', () => {
    it('should return an empty string if any of the input parameters are missing', () => {
    ...
    it('should return the correct barrier_spot_distance with the number of decimal place equal to pip size + 1', () => {
        expect(getAccuBarrierSpotDistance('9017.413', 9017.26, 2)).toEqual('0.153');
        expect(getAccuBarrierSpotDistance('9017.4133', 9017.263, 3)).toEqual('0.1503');
        expect(getAccuBarrierSpotDistance('9017.41355', 9017.2635, 4)).toEqual('0.15005');
    });
});
