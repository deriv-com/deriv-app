...
const BuySellRow = ({ row: advert }) => {
    ...
    if (advert.id === 'WATCH_THIS_SPACE') {
        ...
        return <div style={{ height: '177px' }} data-testid='sliderAnimationElement' />;
    }
