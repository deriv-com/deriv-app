...
const BLOCKED_IMPORTS = {
    '/packages/account': ['@deriv-lib/api-v2'],
    '/packages/api': ['@deriv-lib/api-v2'],
    '/packages/appstore': ['@deriv-lib/api-v2'],
    '/packages/bot-skeleton': ['@deriv-lib/api-v2'],
    '/packages/bot-web-ui': ['@deriv-lib/api-v2'],
    '/packages/cashier': ['@deriv-lib/api-v2'],
    '/packages/cfd': ['@deriv-lib/api-v2'],
    '/packages/components': ['@deriv-lib/api-v2'],
    '/packages/core': ['@deriv-lib/api-v2'],
    '/packages/hooks': ['@deriv-lib/api-v2'],
    '/packages/indicators': ['@deriv-lib/api-v2'],
    '/packages/integration': ['@deriv-lib/api-v2'],
    '/packages/p2p': ['@deriv-lib/api-v2'],
    '/packages/publisher': ['@deriv-lib/api-v2'],
    '/packages/reports': ['@deriv-lib/api-v2'],
    '/packages/shared': ['@deriv-lib/api-v2'],
    '/packages/stores': ['@deriv-lib/api-v2'],
    '/packages/trader': ['@deriv-lib/api-v2'],
    '/packages/translations': ['@deriv-lib/api-v2'],
    '/packages/utils': ['@deriv-lib/api-v2'],
};
