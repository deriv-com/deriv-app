...
const StrategyDescription = observer(({ item, font_size }: TStrategyDescription) => {
    ...
    switch (item.type) {
        case 'text': {
            const class_names = classNames(`ssb-add__description__content ${class_name}`);
            return (
                <>
        ...
        case 'text_italic': {
            const class_names = classNames(`ssb-add__description__content italic ${class_name}`);
            return (
                <>
                    {item?.content?.map((text: string) => (
                        <div className={class_names} key={text}>
        ...
        case 'media': {
            const class_names = classNames(`ssb-add__description__image ${class_name}`);
            return (
