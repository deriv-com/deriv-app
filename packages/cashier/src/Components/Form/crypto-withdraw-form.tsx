...
type CryptoWithdrawFormProps = {
    ...
    crypto_transactions: unknown;
    currency: string;
    current_fiat_currency: string;
    is_loading: boolean;
    onChangeConverterFromAmount: () => void;
    onChangeConverterToAmount: () => void;
    onMountWithdraw: () => void;
    percentage: number;
    percentageSelectorSelectionStatus: () => void;
    recentTransactionOnMount: () => void;
    requestWithdraw: () => void;
    resetConverter: () => void;
    setBlockchainAddress: () => void;
    setWithdrawPercentageSelectorResult: () => void;
