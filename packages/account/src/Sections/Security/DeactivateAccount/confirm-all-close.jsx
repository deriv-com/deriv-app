...
const ConfirmAllClose = () => {
    const [is_modal_open, setModal] = React.useState(false);
    ...
    return (
        <div className='confirm-all-close'>
            ...
            <Button className='confirm-all-close__button' primary large onClick={() => setModal(true)}>
...
export default ConfirmAllClose;
