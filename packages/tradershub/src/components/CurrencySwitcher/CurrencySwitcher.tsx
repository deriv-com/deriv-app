...
const CurrencySwitcher = () => {
    ...
    return (
        <div className='flex items-center justify-between w-full gap-16 p-16 border-solid h-3600 rounded-default border-1 border-system-light-active-background lg:w-auto lg:shrink-0'>
