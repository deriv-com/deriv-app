...
const copyConfig = base => {
    const patterns = [
        ...
        {
            from: path.resolve(__dirname, '../../../node_modules/@jimdanielswasswa/test-chart/dist'),
            to: 'js/smartcharts/',
        },
        {
            from: path.resolve(__dirname, '../../../node_modules/@jimdanielswasswa/test-chart/dist/chart/assets'),
            to: 'assets',
        },
        {
            from: path.resolve(__dirname, '../../../node_modules/@jimdanielswasswa/test-chart/dist/chart/assets'),
