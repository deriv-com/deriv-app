...
export default connect(({ client, modules, ui }) => ({
    ...
    minimum_fee: modules.cashier.account_transfer_store.minimum_fee,
    mt5_login_list: client.mt5_login_list,
    onChangeTransferFrom: modules.cashier.account_transfer_store.onChangeTransferFrom,
    onChangeTransferTo: modules.cashier.account_transfer_store.onChangeTransferTo,
    ...
    transfer_fee: modules.cashier.account_transfer_store.transfer_fee,
    transfer_limit: modules.cashier.account_transfer_store.transfer_limit,
    validateTransferFromAmount: modules.cashier.account_transfer_store.validateTransferFromAmount,
    validateTransferToAmount: modules.cashier.account_transfer_store.validateTransferToAmount,
}))(AccountTransferForm);
