...
describe('LabeledQuantityInputMobile', () => {
    it('should render Stake input', () => {
        render(<LabeledQuantityInputMobile name='amount' input_label='Stake' ariaLabel='Amount' />);
    ...
    it('should render Barrier input', () => {
        render(<LabeledQuantityInputMobile name='barrier_1' input_label='Barrier' ariaLabel='Barrier' />);
