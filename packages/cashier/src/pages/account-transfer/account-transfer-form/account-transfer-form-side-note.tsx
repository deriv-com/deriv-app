    ...
    const getTransferFeeNote = useCallback(() => {
        if (transfer_fee === 0) {
            return is_dxtrade_allowed ? (
                ...
                <Localize
                    i18n_default_text='We do not charge a transfer fee for transfers in the same currency between your Deriv fiat and {{platform_name_mt5}} accounts and your Deriv fiat and {{platform_name_derivez}} accounts.'
                    values={{ platform_name_mt5, platform_name_derivez }}
                />
            );
            ...
            return is_dxtrade_allowed ? (
                ...
                <Localize
                    i18n_default_text='We’ll charge a 1% transfer fee for transfers in different currencies between your Deriv fiat and {{platform_name_mt5}} accounts and your Deriv fiat and {{platform_name_derivez}} accounts.'
                    values={{ platform_name_dxtrade, platform_name_mt5, platform_name_derivez }}
                />
            );
            ...
            return is_dxtrade_allowed ? (
                ...
                <Localize
                    i18n_default_text='We’ll charge a 2% transfer fee or {{minimum_fee}} {{currency}}, whichever is higher, for transfers between your Deriv cryptocurrency and Deriv MT5 accounts and your Deriv cryptocurrency and {{platform_name_derivez}} accounts.'
                    values={{
                        minimum_fee,
                        currency: getCurrencyDisplayCode(currency),
                        platform_name_derivez,
    ...
    const getDxtradeAllowedNotes = useCallback(() => {
        ...
        return (
            <React.Fragment>
                <AccountTransferBullet>
                    <Localize
                        i18n_default_text='You may transfer between your Deriv fiat, cryptocurrency, {{platform_name_mt5}}, and {{platform_name_derivez}} accounts.'
                        values={{ platform_name_mt5, platform_name_derivez }}
                    />
                </AccountTransferBullet>
                <AccountTransferBullet>
                    <Localize
                        i18n_default_text='Each day, you can make up to {{ allowed_internal }} transfers between your Deriv accounts, up to {{ allowed_mt5 }} transfers between your Deriv and {{platform_name_mt5}} accounts, and up to {{ allowed_derivez }} transfers between your Deriv and {{platform_name_derivez}} accounts.'
                        values={{
                            allowed_internal: allowed_transfers_count?.internal,
                            allowed_mt5: allowed_transfers_count?.mt5,
                            allowed_derivez: allowed_transfers_count?.derivez,
