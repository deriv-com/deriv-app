...
describe('TradersHub', () => {
    const mock_store_override = {
        client: { is_logged_in: true },
        traders_hub: { is_eu_user: false, content_flag: ContentFlag.LOW_RISK_CR_EU },
        modules: {
            cashier: {
    ...
    it('should display Multipliers and CFDs section in order if the user is non eu', () => {
        render_container();
        mock_store_override.traders_hub.is_eu_user = false;
        const dashboard_sections = screen.getByTestId('dt_traders_hub');
    ...
    it('should display Multipliers and CFDs section in reverse order if the user is eu', () => {
        render_container();
        mock_store_override.traders_hub.is_eu_user = true;
        const dashboard_sections = screen.getByTestId('dt_traders_hub');
        expect(dashboard_sections).toHaveClass('traders-hub__main-container');
    });
