...
import CompareAccounts from '../compare-accounts';
...
jest.mock('../../../../Containers/cfd-compare-accounts/instruments-icon-with-label', () =>
    jest.fn(() => <div>Mocked Icon With Label</div>)
);
...
describe('<CompareAccounts />', () => {
    ...
    it('should render the component and redirect to compare account page', () => {
        ...
        render(<CompareAccounts />, { wrapper });
