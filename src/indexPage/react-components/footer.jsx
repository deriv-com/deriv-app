            ...
            <div className='container eu-hide invisible'>
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        <p>
                            {translate(
                                'In the EU, financial products are offered by Binary Investments (Europe) Ltd., W Business Centre, Level 3, Triq Dun Karm, Birkirkara, BKR 9033, Malta, regulated as a Category 3 Investment Services provider by the Malta Financial Services Authority ({$0}licence no. IS/70156{$1}).',
                                [
                                    `<a href="${createUrl({
                                        path: 'download/WS-Binary-Investments-Europe-Limited.pdf',
                                        isNonBotPage: true,
                                    })}" target="_blank">`,
                                    '</a>',
                                ]
                        ...
                        <p>
                            {translate(
                                ...
                                [
                                    '<a href="https://www.vfsc.vu/wp-content/uploads/2015/12/List-of-Licensees-under-Dealers-in-Securities-Licensing-Act-CAP-70-18.11.2016.pdf" target="_blank" rel="noopener noreferrer">',
                                    '</a>',
                                    `<a href="${createUrl({
                                        path: 'download/regulation/BVI_license.pdf',
                                        isNonBotPage: true,
                                    })}" target="_blank">`,
                                    '</a>',
                                    `<a href="${createUrl({
                                        path: 'download/regulation/Labuan-license.pdf',
                                        isNonBotPage: true,
                                    })}" target="_blank">`,
                                    '</a>',
                                ]
            ...
            <div className='container eu-show invisible'>
                    ...
                    <div className='gr-12'>
                        <div className='icon-row flex-row'>
                            <div className='regulation-logos flex-row'>
                                <a
                                    className='iom-icon'
                                    href='https://www.gov.im/gambling/'
                                    target='_blank'
                                    rel='noopener noreferrer'
                                >
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        ...
                        <p>
                            {translate(
                                'In the Isle of Man and the UK, Volatility Indices are offered by Binary (IOM) Ltd., First Floor, Millennium House, Victoria Road, Douglas, IM2 4RW, Isle of Man, British Isles; licensed and regulated respectively by (1) the Gambling Supervision Commission in the Isle of Man (current licence issued on 31 August 2017) and by (2) the Gambling Commission in the UK (licence {$0}reference no: 39172{$1}).',
                                [
                                    '<a href="https://secure.gamblingcommission.gov.uk/PublicRegister/Search/Detail/39172" target="_blank" rel="noopener noreferrer">',
                                    '</a>',
                                ]
                            )}
                        </p>
