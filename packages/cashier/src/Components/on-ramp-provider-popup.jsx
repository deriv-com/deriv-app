...
export default connect(({ modules, ui }) => ({
    api_error: modules.cashier.general.onramp.api_error,
    deposit_address: modules.cashier.general.onramp.deposit_address,
    is_dark_mode_on: ui.is_dark_mode_on,
    is_deposit_address_loading: modules.cashier.general.onramp.is_deposit_address_loading,
    is_deposit_address_popover_open: modules.cashier.general.onramp.is_deposit_address_popover_open,
    is_requesting_widget_html: modules.cashier.general.onramp.is_requesting_widget_html,
    onClickCopyDepositAddress: modules.cashier.general.onramp.onClickCopyDepositAddress,
    onClickDisclaimerContinue: modules.cashier.general.onramp.onClickDisclaimerContinue,
    onClickGoToDepositPage: modules.cashier.general.onramp.onClickGoToDepositPage,
    selected_provider: modules.cashier.general.onramp.selected_provider,
    setDepositAddressRef: modules.cashier.general.onramp.setDepositAddressRef,
    ...
    should_show_widget: modules.cashier.general.onramp.should_show_widget,
    widget_error: modules.cashier.general.onramp.widget_error,
    widget_html: modules.cashier.general.onramp.widget_html,
}))(OnRampProviderPopup);
