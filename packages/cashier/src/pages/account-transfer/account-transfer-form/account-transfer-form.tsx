...
const AccountTransferForm = observer(({ error, onClickDeposit, onClickNotes, onClose }: TAccountTransferFormProps) => {
                                            ...
                                            {({ field }: FieldProps<string>) => (
                                                <Input
                                                    ...
                                                    classNameHint={classNames('account-transfer-form__hint', {
                                                        'account-transfer-form__hint__disabled':
                                                            is_mt5_restricted || has_reached_maximum_daily_transfers,
                                                    })}
