...
const CompareAccountsScreen = () => {
    ...
    return (
        <div className='overflow-x-auto overflow-y-scroll lg:w-full lg:h-full m-50 max-h-[800px] pt-0 px-50 pb-[201px]'>
            <CompareAccountsHeader isDemo={isDemo} isEuRegion={isEuRegion} />
            <div className='flex justify-center p-20 lg:my-50 lg:mx-auto max-w-[1232px]'>
