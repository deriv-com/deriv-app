...
type TradeSettingsExtensionsProps = {
    populateSettingsExtensions: () => void;
    store: unknown;
};
...
const TradeSettingsExtensions = ({ populateSettingsExtensions, store }: TradeSettingsExtensionsProps) => {
