...
import { WS, getPlatformRedirect, platforms, isNavigationFromDerivGO } from '@deriv/shared';
...
const ProofOfIdentityContainer = ({
    ...
    const should_show_redirect_btn = !isNavigationFromDerivGO() && Object.keys(platforms).includes(from_platform.ref);
