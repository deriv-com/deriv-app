...
const ResetPasswordIntent = ({ current_list, children, is_eu, ...props }: TResetPasswordIntent) => {
    ...
    const has_intent =
        ...
        /(real|demo)\.(all|all_svg|dxtrade|synthetic|synthetic_svg|synthetic_bvi|financial|financial_demo|financial_svg|financial_stp|financial_bvi|financial_fx|financial_v)/.test(
            reset_password_intent
        );
