...
import { DrawerItem, DrawerToggle } from 'App/Components/Elements/Drawer';
            ...
            {is_mobile && (
                <React.Fragment>
                    ...
                    <DrawerItem
                        ...
                        icon={<Icon icon='IcPortfolio' className='drawer__icon' />}
                        link_to={routes.portfolio}
                    />
                    <DrawerItem
                        text={localize('Statement')}
                        icon={<Icon icon='IcReports' className='drawer__icon' />}
                        link_to={routes.statement}
                    />
                    <hr className='hr' />
                    <DrawerToggle text={localize('Dark Mode')} toggle={toggleDarkMode} to_toggle={is_dark_mode} />
