...
import { shouldShowIdentityInformation, getDocumentData, preventEmptyClipboardPaste } from 'Helpers/utils.js';
...
const PersonalDetails = ({
    ...
    React.useEffect(() => {
        ...
        setDocumentList([
            ...
            { id: '#NA', text: localize('I don’t have any of these') },
        ]);
    }, [document_data]);
    ...
    */
    ...
    const initial_form_values = {
        ...
        document_number: props.value ? props.value.document_number : '',
    };
                                                        ...
                                                        {'tax_identification_confirm' in props.value && (
                                                            <Checkbox
                                                                ...
                                                                label={localize(
                                                                    ...
                                                                    {
                                                                        legal_entity_name:
                                                                            getLegalEntityName('maltainvest'),
                                                                    }
                                                                )}
                                                                renderlabel={title => (
