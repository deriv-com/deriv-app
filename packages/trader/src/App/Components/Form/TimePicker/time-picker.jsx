...
TimePicker.propTypes = {
    ...
    end_times: PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.object]),
    ...
    start_times: PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.object]),
