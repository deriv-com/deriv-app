...
describe('WheelPickerMobile', () => {
    const options = ['0.12', '0.21', '0.2231231', '0.34', '0.33', '0.38', '0.09', '0.76', '0.77', '0.78', '0.79'];
    ...
    it('sets default value from props correctly', () => {
        ...
        render(<WheelPickerMobile options={options} onChange={mockOnChange} defaultValue={defaultValue} />);
