...
Blockly.Blocks.procedures_defreturn = {
    ...
    meta(){
        return {
            ...
            'description' : localize('This block executes nested instructions (bloks) and can return a value which is typically the result of nested instructions execution.'),
        };
    },
