...
export const JurisdictionCardClass = cva(
    'items-center rounded-16 border-sm border-solid cursor-pointer flex flex-col justify-center w-full lg:w-1/4 relative h-full transition-shadow transition-transform duration-300 [transform-style:preserve-3d] transform-gpu',
    {
        compoundVariants: [
            {
...
export const JurisdictionCardTagClass = cva('rounded-xs text-system-light-primary-background px-500 py-[5px]', {
    defaultVariants: {
