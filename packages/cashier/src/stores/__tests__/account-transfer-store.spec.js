...
describe('AccountTransferStore', () => {
    ...
    it('should sort and set accounts when calling sortAccountsTransfer method', async () => {
        ...
        expect(account_transfer_store.accounts_list[3].text).toMatch(/^(.)*$/);
        expect(account_transfer_store.accounts_list[4].text).toMatch(/^(.)*$/);
        expect(account_transfer_store.accounts_list[5].text).toMatch(/^(.)*$/);
        expect(account_transfer_store.accounts_list[6].text).toMatch(/^(.)*$/);
