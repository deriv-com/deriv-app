...
type RealityCheckModalProps = {
    disableApp: () => void;
    enableApp: () => void;
    history: unknown;
    logoutClient: () => void;
    is_visible: boolean;
    reality_check_dismissed: boolean;
    reality_check_duration: number;
    setRealityCheckDuration: () => void;
    setReportsTabIndex: () => void;
    setVisibilityRealityCheck: () => void;
};
