...
export const general_messages = {
    getWelcomeHeader: (is_logged_in, platform) => {
        if (platform === 'dxtrade') {
            if (is_logged_in) return localize('Welcome to your Deriv DXtrade dashboard');
            return localize('Welcome to Deriv DXtrade');
    ...
    getDownloadHeader: platform => {
        if (platform === 'dxtrade') return localize('Run Deriv DXtrade on your browser or download the mobile app');
        else if (platform === 'mt5')
