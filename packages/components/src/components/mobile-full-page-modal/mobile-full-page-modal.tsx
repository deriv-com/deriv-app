...
type MobileFullPageModalProps = {
    className: string;
    container_children: unknown;
    header: string;
    ...
    renderPageFooterChildren: () => void;
    page_footer_className: string;
    page_header_className: string;
    page_header_text: string;
    renderPageHeaderTrailingIcon: () => void;
    renderPageHeaderText: () => void;
    should_header_stick_body: boolean;
    should_wrap_body: boolean;
};
