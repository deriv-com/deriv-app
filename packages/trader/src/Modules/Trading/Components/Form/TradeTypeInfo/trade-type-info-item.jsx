...
import { Button, DesktopWrapper, Icon, ThemedScrollbars } from '@deriv/components';
                        ...
                        {itemListLength > 1 && (
                            <div>
                                <Button
                                    ...
                                    text={localize('Choose {{trade_type}}', {
        ...
        {itemListLength > 1 && (
            <div className='trade-type-info-navigation'>
                <div
                    ...
                    className='trade-type-info-navigation__icon'
                    onClick={() => handlePrevClick(itemList)}
                >
                ...
                <div
                    ...
                    className='trade-type-info-navigation__icon'
                    onClick={() => handleNextClick(itemList)}
                >
