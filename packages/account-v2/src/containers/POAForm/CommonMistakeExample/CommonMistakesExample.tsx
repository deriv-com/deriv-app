...
export const CommonMistakesExamples = ({ description, image }: TCommonMistakeExamplePartialsProps) => (
    <div className='flex flex-col bg-solid-red-5/[0.16] items-center space-y-16 p-8 box-border border-solid border-1 border-solid-grey-2 rounded-4 w-[237px] h-[218px]'>
        {image}
