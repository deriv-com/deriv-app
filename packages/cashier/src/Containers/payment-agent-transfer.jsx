...
export default connect(({ client, modules }) => ({
    ...
    container: modules.cashier.payment_agent_transfer_store.container,
    ...
    is_transfer_successful: modules.cashier.payment_agent_transfer_store.is_transfer_successful,
    is_try_transfer_successful: modules.cashier.payment_agent_transfer_store.is_try_transfer_successful,
    onMount: modules.cashier.payment_agent_transfer_store.onMountPaymentAgentTransfer,
    onUnMount: modules.cashier.payment_agent_transfer_store.resetPaymentAgentTransfer,
