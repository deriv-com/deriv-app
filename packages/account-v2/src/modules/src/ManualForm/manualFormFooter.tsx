...
export const ManualFormFooter = () => (
    <div className='grid items-center grid-cols-2 justify-items-center gap-1200 lg:flex lg:justify-evenly'>
        {FOOTER_ITEMS.map(footer => (
            <div className='w-[12.4rem] flex flex-col justify-start items-center' key={footer.text}>
                <div className='flex items-center justify-center w-3600 h-3600'>{footer.icon}</div>
