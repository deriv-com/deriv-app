...
describe('ContractTypeItem component', () => {
    ...
    it('should has "contract-type-item--selected" class when type.value array includes value', () => {
    ...
    it('should has "contract-type-item--selected" class when type.value is a string equal to value', () => {
