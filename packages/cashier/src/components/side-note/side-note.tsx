...
import { TReactChildren, TReactElement, TSideNotesProps } from 'Types';
...
type TSideNoteProps = {
    children?: TReactChildren[] | TReactElement;
    className?: string;
    has_bullets?: boolean;
    has_title?: boolean;
    is_mobile?: boolean;
                ...
                <Wrapper>
                    <div className={classNames('side-note', { 'side-note--mobile': isMobile() }, className)}>
                        {has_title && (
                            <SideNoteTitle
                                title={title}
                                children_length={Array.isArray(children) ? children?.length : 0}
