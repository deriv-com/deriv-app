...
export default connect(({ ui, client, common, modules }) => ({
    ...
    continueRoute: modules.cashier.cashier_store.continueRoute,
    ...
    replaceCashierMenuOnclick: modules.cashier.cashier_store.replaceCashierMenuOnclick,
    ...
    should_show_all_available_currencies: modules.cashier.cashier_store.should_show_all_available_currencies,
