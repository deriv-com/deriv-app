        ...
        <div className='my-profile__cell'>
            <div className='my-profile__cell-data'>
                <div className='my-profile__cell-data-main'>
                    {value}
                    <sub className='my-profile__cell-data-dimension'>{dimension}</sub>
                </div>
                <div className='my-profile__cell-data-sub'>
                    <div className='my-profile__cell-data-sub-upper'>{upper_sub_value}</div>
                    <div className='my-profile__cell-data-sub-lower'>{lower_sub_value}</div>
                </div>
            </div>
            <h2 className='my-profile__cell-title'>{title}</h2>
        </div>
    );
};
    ...
    return (
        <div className='my-profile'>
            ...
            <div className='my-profile__data'>
                <Cell title={localize('Security Deposit')} value={user_data.security_deposit} />
                <Cell
                ...
                />
                <Cell title={localize('Trades in the last 30 days')} value={user_data.past_month_trades} />
                <Cell title={localize('30 day completion rate')} value={`${user_data.past_month_completion_rate}%`} />
                <Cell
