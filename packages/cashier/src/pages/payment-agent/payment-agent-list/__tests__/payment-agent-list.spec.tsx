...
jest.mock('Pages/payment-agent/payment-agent-withdrawal-locked', () => jest.fn(() => 'PaymentAgentWithdrawalLocked'));
jest.mock('Components/verification-email', () => jest.fn(() => 'The email has been sent!'));
jest.mock('Pages/payment-agent/payment-agent-container', () => jest.fn(() => 'Payment agent container'));
