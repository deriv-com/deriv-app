...
const payment_methods = {
    ...
    'Banco de Pichincha': ['BANCO DE PICHINCHA', 'Pichincha'],
    'Banco de Produbanco': ['BANCO DE PRODUBANCO'],
    'Banco del Pacifico': ['BANCO DE PACIFICO', 'Pacifico'],
    'Banco Internacional': ['BANCO INTERNACIONAL'],
    'Banco Internacional de Moçambique (BIM)': ['Bim', 'Transferencia Bim'],
    'Bancobu Bank eNoti': ['Bancobu e-noti'],
    'Bank AL Habib': ['bank al habib', 'Bank Alhabib'],
    'Bank Negara Indonesia (BNI)': ['BNI', 'BankBNI'],
    'Bank Of Ceylon (BOC)': ['Bankofceylon', 'Boc Peoples Bank'],
    'Bank Rakyat Indonesia (BRI)': ['BankBri', 'BankBRI', 'BRI', 'BRI dan Ewallet'],
    'Bank transfer': [
    ...
    'E-transfer': ['electronic transfers and cash deposits', 'E-Transfers', 'OnlineTransfer'],
    'E-wallet': [
        'Banks BHIMUP BTC Ewallet GooglePay LocalBank Paypal Paytm Perfect Money PhonePhe',
        'Bank and E-wallet',
        'bank ewallet',
    ...
    'First Bank of Nigeria': ['First bank', 'First Bank', 'FirstBank', 'FIRST BANK', 'Firstbank'],
    ...
    'Instant Money': ['InstantMoney', 'Instant money stambic bank', 'Instant money stanbic', 'Instant money'],
    ...
    'Luno Wallet': ['Luno', 'Luno crypto wallet', 'Luno e-wallet'],
    'Mandiri Bank': ['Mandiri', 'MANDIRI', 'MandiriSyariah', 'BankMandiri'],
    ...
    'Permata Bank': ['PermataBank', 'PERMATA'],
    PhonePhe: [
        'Banks BHIMUP BTC Ewallet GooglePay LocalBank Paypal Paytm Perfect Money PhonePhe',
        'Phonepay',
        'phonepe',
    ...
    RIA: ['Ria', 'RIA'],
    'RTGS Transfers': ['rtgs', 'RTGS', 'Rtgs bank transfer', 'RTGS transfers', 'Rtgs'],
    Safaricom: ['AbesafaricomMpesa Transfers', 'AbeSafaricomMpesaTransfers', 'safaricom mpesa'],
    'Sama Money': ['Sama money'],
    Skrill: ['Skill', 'Skril', 'skrill', 'SKRILL', 'skrillpayments', 'Skrll', 'SkrillCrypto', 'Skrill Neteller Crypto'],
