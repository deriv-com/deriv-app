...
import { ChartModal, DashboardComponent } from '../../tabs/dashboard';
import RunStrategy from '../../tabs/dashboard/run-strategy';
import Tutorial from '../../tabs/tutorials';
import RunPanel from '../run-panel';
import { tour_list } from '../tours/utils';
