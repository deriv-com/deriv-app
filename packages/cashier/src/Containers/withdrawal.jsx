...
export default connect(({ client, modules }) => ({
    ...
    check10kLimit: modules.cashier.cashier_store.check10kLimit,
    container: modules.cashier.cashier_store.config.withdraw.container,
    crypto_transactions: modules.cashier.transaction_history.crypto_transactions,
    currency: client.currency,
    current_currency_type: client.current_currency_type,
    error: modules.cashier.cashier_store.config.withdraw.error,
    iframe_url: modules.cashier.cashier_store.config.withdraw.iframe_url,
    is_10k_withdrawal_limit_reached: modules.cashier.cashier_store.is_10k_withdrawal_limit_reached,
    ...
    is_withdraw_confirmed: modules.cashier.cashier_store.is_withdraw_confirmed,
