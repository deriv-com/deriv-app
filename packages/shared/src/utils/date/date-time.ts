...
export const initMoment = (lang: string) => {
    const hasEnMomentLocale = ['EN', 'AR', 'BN', 'SI', 'KO']; // 'AR', 'BN' & 'SI' langs have non-numeric dates ('২০২৪-০৫-০৭'), our current usage of moment requires us to make all dates numeric
