...
const IconAccountsCurrency = ({ type, className, height = 20, width = 20, vb_height = 20, vb_width = 20 }) => {
    let IconCurrency;
    if (type) {
        switch (type) {
            case 'aud':
            ...
            case 'real_labuan_advanced':
                IconCurrency = (
                    <g fill='none' fillRule='evenodd'>
                        <path fill='#85ACB0' fillRule='nonzero' d='M29.135 28.935a4.35 4.35 0 0 1 7.5.465l4.265 8.56 4.26 8.565c.075.15.14.3.2.45 1.33 3.62-3 6.755-6.195 4.615L34.5 48.45a5.5 5.5 0 0 0-5.535-.345M16.865 28.935a4.35 4.35 0 0 0-7.5.465l-4.29 8.56-4.26 8.565a5.9 5.9 0 0 0-.2.45c-1.33 3.62 3 6.755 6.195 4.615l4.69-3.14a5.5 5.5 0 0 1 5.535-.345' />
                        <path fill='#C7E5E5' fillRule='nonzero' d='M24.17 3.94V2.265a1.515 1.515 0 1 0-3.03 0V3.94C16.64 6.235 9.105 17.29 9.105 30.6c0 8.76 2.08 16.55 5.305 21.5l16.445.07c3.25-4.95 5.35-12.775 5.35-21.575 0-13.305-7.56-24.36-12.035-26.655z' />
                        <ellipse cx='7' cy='7.46' fill='#85ACB0' fillRule='nonzero' opacity='.41' rx='6.9' ry='7.165' transform='translate(16 14.5)' />
                        <path fill='#84ABAE' fillRule='nonzero' d='M23 17.3a3.87 3.87 0 1 1 .01 7.74A3.87 3.87 0 0 1 23 17.3zm0-2.5a6.37 6.37 0 1 0 6.365 6.365A6.365 6.365 0 0 0 23 14.8z' />
                        <path fill='#BCCDCE' fillRule='nonzero' d='M21.39 58.135l-3.245-7.455a2.14 2.14 0 0 1 .255-2.135l3.245-4.17a1.675 1.675 0 0 1 2.71 0l3.245 4.17c.462.614.56 1.43.255 2.135l-3.245 7.455a1.72 1.72 0 0 1-3.22 0z' />
                        <path fill='#85ACB0' fillRule='nonzero' d='M21.645 44.375l-3.245 4.17a2.14 2.14 0 0 0-.255 2.135l3.245 7.455c.26.664.897 1.105 1.61 1.115V43.685a1.705 1.705 0 0 0-1.355.69z' opacity='.45' />
            ...
            case 'real_svg':
                IconCurrency = (
                    <g fill='none' fillRule='evenodd' transform='translate(-5 -13)'>
                        <path fill='#C6E4E4' fillRule='nonzero' d='M57.715 41.705S57 28.15 57 27.07c0-6.271-5.084-11.355-11.355-11.355h-27.1A11.35 11.35 0 0 0 7.195 27.07c0 .705-1.305 14.635-1.305 14.635-.65 7.365 7.895 9.935 13.47 4.055l6.955-7.34H37.29l6.955 7.34c5.575 5.88 14.12 3.31 13.47-4.055z' />
                        <rect width='5.745' height='3.59' x='28.715' y='25.865' fill='#85ACB0' fillRule='nonzero' opacity='.81' rx='1.795' />
                        <circle cx='18.315' cy='27.66' r='8.25' fill='#E0F0F0' fillRule='nonzero' />
                        <rect width='3.145' height='11' x='16.745' y='22.16' fill='#85ACB0' fillRule='nonzero' opacity='.5' rx='1.435' />
                        <rect width='3.145' height='11' x='16.742' y='22.163' fill='#85ACB0' fillRule='nonzero' opacity='.5' rx='1.435' transform='rotate(90 18.315 27.663)' />
                        <circle cx='45.775' cy='27.66' r='8.25' fill='#E0F0F0' fillRule='nonzero' />
                        <path fill='#85ACB0' fillRule='nonzero' d='M47.57 22.945a1.575 1.575 0 0 0-1.57-1.57h-.45c-.86.01-1.55.71-1.55 1.57v1.125a1.795 1.795 0 0 0 1.795 1.795 1.795 1.795 0 0 0 1.795-1.795l-.02-1.125zM44 32.375a1.565 1.565 0 0 0 1.57 1.57H46a1.57 1.57 0 0 0 1.57-1.57V31.25a1.795 1.795 0 0 0-1.795-1.795A1.795 1.795 0 0 0 44 31.25v1.125z' opacity='.81' />
                        <rect width='4.49' height='3.59' x='39.49' y='25.865' fill='#85ACB0' fillRule='nonzero' opacity='.81' rx='1.795' />
                        <rect width='4.49' height='3.59' x='47.57' y='25.865' fill='#85ACB0' fillRule='nonzero' opacity='.81' rx='1.795' />
            ...
            case 'real_vanuatu_standard':
                IconCurrency = (
                    <g fill='none' fillRule='evenodd'>
                        <path fill='#C6E4E4' fillRule='nonzero' d='M29.75 31.555l3.75-1.435 17.935 4.035.045-4.935L45.42 26v-2.115a.88.88 0 0 0-.855-.885h-1.76a.88.88 0 0 0-.89.875v.285l-5.38-2.875V19.46a.88.88 0 0 0-.87-.89h-1.76a.88.88 0 0 0-.89.875l-3.16-1.675.095-10.69c.04-4.075-3.7-6.375-3.7-6.375S22.5 2.925 22.465 7l-.095 10.69-3.185 1.615a.88.88 0 0 0-.875-.89h-1.76a.88.88 0 0 0-.89.875v1.83l-5.44 2.74v-.29a.88.88 0 0 0-.875-.89h-1.76a.88.88 0 0 0-.885.875v2.115l-6.155 3.1L.5 33.705 18.5 30l3.745 1.5-.04 4.29s.09 3.305.455 7.08l-7.72 4.5v2.815l9.23-1.345c.425 2.05 1 3.745 1.71 4.5.74-.735 1.33-2.415 1.79-4.46l9.095 1.5v-2.82l-7.635-4.65c.435-3.765.585-7.07.585-7.07l.035-4.285z' />
                        <path fill='#85ACB0' fillRule='nonzero' d='M30.17 43.54l-1.04-.63s-.695 4.13-1.5 5.93l1.265.21a41.88 41.88 0 0 0 1.275-5.51zM22.67 42.855l-1.05.61c.282 1.87.684 3.718 1.205 5.535l1.325-.19c-.75-1.815-1.5-5.955-1.5-5.955h.02zM31.46 18.595l-1.585-.84-.125 13.8 1.6-.61zM20.765 18.505l-.11 12.345 1.58.63.125-13.785z' opacity='.39' />
                        <path fill='#84ABAE' fillRule='nonzero' d='M31.38 27.445l-.03 3.5 2.17-.825 17.935 4.035.02-2.19zM20.69 27.35l-.03 3.5-2.155-.865L.5 33.705l.02-2.19zM22.6 48.165l-7.675 1.12v.87l7.9-1.155c-.07-.245-.145-.5-.225-.835zM41.915 23.855v.285l-5.38-2.855V19.46a.88.88 0 0 0-.87-.89h-1.76a.88.88 0 0 0-.89.875L45.42 26v-2.115a.88.88 0 0 0-.855-.885h-1.76a.88.88 0 0 0-.89.855zM18.31 18.415h-1.76a.88.88 0 0 0-.89.875v1.83l-5.44 2.74v-.29a.88.88 0 0 0-.875-.89h-1.76a.88.88 0 0 0-.885.875v2.115l12.5-6.35a.88.88 0 0 0-.89-.905zM29.15 48.225c-.085.31-.165.59-.23.825h-.03l7.885 1.295v-.87l-7.625-1.25z' />
                        <path fill='#84ABAE' fillRule='nonzero' d='M29.15 48.225l-1.195-.2c-.1.3-.2.58-.3.815l1.265.21c.065-.235.145-.5.23-.825zM22.825 49l1.325-.19a9.84 9.84 0 0 1-.285-.81l-1.265.165c.08.335.155.59.225.835zM31.38 27.445l-1.59-.355-.04 4.465 1.6-.61zM20.69 27.35v.005l-.035 3.495 1.58.63.04-4.465zM29.125 6.715a5.67 5.67 0 0 0-.125-.84 1.695 1.695 0 0 0-1.29-1.31 7.21 7.21 0 0 0-3-.025 1.705 1.705 0 0 0-1.315 1.285 6.33 6.33 0 0 0-.125.835 5.655 5.655 0 0 1 5.855.055z' />
    ...
    return (
        <svg className={classNames('inline-icon', className)} width={width} height={height} viewBox={`0 0 ${vb_width} ${vb_height}`}>
            {IconCurrency}
        </svg>
    );
};
...
IconAccountsCurrency.propTypes = {
    ...
    vb_height: PropTypes.number,
    vb_width : PropTypes.number,
