...
describe('<CurrencySelector/>', () => {
    ...
    const mt5_non_eu =
        'You are limited to one fiat account. You won’t be able to change your account currency if you have already made your first deposit or created a real DMT5 account.';
