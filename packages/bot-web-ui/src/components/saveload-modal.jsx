    ...
    return (
        <div className='saveload-type__container'>
            <div className='saveload-type__radio'>
                {icon &&
                    React.cloneElement(icon, { className: classNames('saveload-type__icon', icon.props.className) })}
                <p
                    className={classNames('saveload-type__radio-text', {
            ...
            {is_drive_radio && (
                <p className='saveload-type__drive-status' onClick={onDriveConnect}>
