    ...
    if (category) {
        switch (category) {
            ...
            case 'end':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('If you select "Ends In", you win the payout if the exit spot is strictly higher than the Low barrier AND strictly lower than the High barrier.') }</p>
                        <p>{ localize('If you select "Ends Out", you win the payout if the exit spot is EITHER strictly higher than the High barrier, OR strictly lower than the Low barrier.') }</p>
            ...
            case 'stay':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('If you select "Stays In”, you win the payout if the market stays between (does not touch) either the High barrier or the Low barrier at any time during the contract period.') }</p>
                        <p>{ localize('If you select "Goes Out", you win the payout if the market touches either the High barrier or the Low barrier at any time during the contract period.') }</p>
                    </React.Fragment>
                );
                break;
            case 'match_diff':
            ...
            case 'run_high_low':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('If you select "Only Ups", you win the payout if consecutive ticks rise successively after the entry spot. No payout if any tick falls or is equal to any of the previous ticks.') }</p>
                        <p>{ localize('If you select "Only Downs", you win the payout if consecutive ticks fall successively after the entry spot. No payout if any tick rises or is equal to any of the previous ticks.') }</p>
                    </React.Fragment>
                );
                break;
            case 'reset':
            ...
            case 'callputspread':
                TradeTypeTemplate = (
                    <React.Fragment>
                        ...
                        <p>{ localize('Win maximum payout if the exit spot is higher than or equal to the upper barrier.') }</p>
            ...
            case 'tick_high_low':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('If you select "High Tick", you win the payout if the selected tick is the highest among the next five ticks.') }</p>
                        <p>{ localize('If you select "Low Tick", you win the payout if the selected tick is the lowest among the next five ticks.') }</p>
                    </React.Fragment>
                );
                break;
            case 'lb_high_low':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('By purchasing the "High-to-Low" contract, you\'ll win the multiplier times the difference between the high and low over the duration of the contract.') }</p>
                        <p>{ localize('The high is the highest point ever reached by the market during the contract period.')}</p>
                        <p>{ localize('The low is the lowest point ever reached by the market during the contract period.')}</p>
                        <p>{ localize('The close is the latest tick at or before the end time. If you selected a specific end time, the end time is the selected time.') }</p>
                    </React.Fragment>
                );
                break;
            case 'lb_put':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('By purchasing the "High-to-Close" contract, you\'ll win the multiplier times the difference between the high and close over the duration of the contract.')}</p>
                        <p>{ localize('The high is the highest point ever reached by the market during the contract period.')}</p>
                        <p>{ localize('The low is the lowest point ever reached by the market during the contract period.')}</p>
                        <p>{localize('The close is the latest tick at or before the end time. If you selected a specific end time, the end time is the selected time.')}</p>
                    </React.Fragment>
            ...
            case 'lb_call':
                TradeTypeTemplate = (
                    <React.Fragment>
                        <p>{ localize('By purchasing the "Close-to-Low" contract, you\'ll win the multiplier times the difference between the close and low over the duration of the contract.')}</p>
                        <p>{ localize('The high is the highest point ever reached by the market during the contract period.')}</p>
                        <p>{ localize('The low is the lowest point ever reached by the market during the contract period.')}</p>
                        <p>{localize('The close is the latest tick at or before the end time. If you selected a specific end time, the end time is the selected time.')}</p>
                    </React.Fragment>
