...
export default class ToolbarStore {
    ...
    @observable file_name = 'binary-bot';
    ...
    @action.bound onConfirmSave = () => {
        if (this.saveload_type === 'google-drive') {
            ...
            const file_name = document.getElementById('save-filename').value || 'binary-bot';
    ...
    @action.bound onZoomInClick = () => {
        this.zoomOnPlusMinus(true);
    }

    @action.bound onZoomOutClick = () => {
