...
const TradeTypeInfoDialog = ({ children, is_mobile, open, onClose, title }) =>
    is_mobile ? (
        <MobileDialog visible={open} onClose={onClose} title={title} wrapperClassName='trade-type-info-modal'>
            {children}
        </MobileDialog>
    ) : (
        <CSSTransition
