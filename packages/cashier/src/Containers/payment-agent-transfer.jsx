...
export default connect(({ client, modules }) => ({
    ...
    container: modules.cashier.cashier_store.config.payment_agent_transfer.container,
    ...
    is_transfer_successful: modules.cashier.cashier_store.config.payment_agent_transfer.is_transfer_successful,
    is_try_transfer_successful: modules.cashier.cashier_store.config.payment_agent_transfer.is_try_transfer_successful,
    onMount: modules.cashier.cashier_store.onMountPaymentAgentTransfer,
    onUnMount: modules.cashier.cashier_store.resetPaymentAgentTransfer,
