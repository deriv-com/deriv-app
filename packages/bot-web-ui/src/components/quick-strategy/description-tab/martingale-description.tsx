...
export const MARTINGALE = [
    {
        title: <Localize key={0} i18n_default_text={'Exploring the Martingale strategy in Deriv Bot'} />,
        content: (
            <>
    ...
    {
        title: <Localize key={0} i18n_default_text={'Key Parameters'} />,
        content: (
            <Localize
                key={0}
                i18n_default_text={'These are the trade parameters used in Deriv Bot with Martingale strategy.'}
            />
        ),
    },
    {
        content: (
            <Localize
                key={0}
                i18n_default_text={
                    '<0>Initial stake:</0> The amount you pay to enter a trade. This is the starting point for any changes in stake depending on the dynamic of the strategy being used.'
                }
    ...
    },
    {
        content: (
            <Localize
                key={0}
                i18n_default_text={
                    "<0>Multiplier:</0> The multiplier used to increase your stake if you're losing a trade. The value must be greater than 1."
                }
                components={[<strong key={0} />]}
            />
        ),
    },
    {
        content: (
            <Localize
                key={0}
                i18n_default_text={
                    '<0>Profit threshold:</0> The bot will stop trading if your total profit exceeds this amount.'
                }
                components={[<strong key={0} />]}
            />
        ),
    },
    {
        content: (
            <Localize
                key={0}
                i18n_default_text={
                    '<0>Loss threshold:</0> The bot will stop trading if your total loss exceeds this amount.'
                }
                components={[<strong key={0} />]}
            />
        ),
    },
    {
        content: (
            <Localize
                key={0}
                i18n_default_text={
                    '<0>Maximum stake:</0> The maximum amount you are willing to pay to enter a single trade. The stake for your next trade will reset to the initial stake if it exceeds this value. This is an optional risk management parameter.'
                }
                components={[<strong key={0} />]}
            />
        ),
    ...
    {
        title: <Localize key={0} i18n_default_text={'An example of Martingale strategy'} />,
        image: getImageLocation('martingale.png'),
    },
    {
        content: (
            <>
