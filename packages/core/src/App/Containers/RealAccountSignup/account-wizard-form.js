...
const isMaltaAccount = ({ real_account_signup_target }) => real_account_signup_target === Jurisdiction.MALTA_INVEST;
...
const shouldShowIdentityInformation = ({ account_settings, residence, residence_list, real_account_signup_target }) => {
    ...
    const maltainvest = real_account_signup_target === Jurisdiction.MALTA_INVEST;
