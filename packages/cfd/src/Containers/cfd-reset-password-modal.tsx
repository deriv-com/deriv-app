...
const ResetPasswordIntent = ({ current_list, children, is_eu, ...props }: TResetPasswordIntent) => {
    ...
    const has_intent =
        ...
        /(real|demo)\.(financial|financial_stp|financial_svg|financial_bvi|financial_fx|financial_v|synthetic|synthetic_svg|synthetic_bvi|synthetic_v|all_svg|dxtrade|all)/.test(
            reset_password_intent
        );
